...
#define ComConf_ComSignal_B_RLS_DewPoint_oB_RLS_oCAN00_421173c7_Rx    0u
#define ComConf_ComSignal_B_RLS_Offline_Calibration_Result_oB_RLS_oCAN00_f4cfd300_Rx 1u
#define ComConf_ComSignal_B_RLS_SolarLeft_oB_RLS_oCAN00_3b2a55ba_Rx   2u
#define ComConf_ComSignal_B_RLS_SolarRight_oB_RLS_oCAN00_6bd7c4e8_Rx  3u
#define ComConf_ComSignal_B_RLS_WindshieldTemp_oB_RLS_oCAN00_6dbe9061_Rx 4u
#define ComConf_ComSignal_B_RLS_relativeHumidity_oB_RLS_oCAN00_e615f445_Rx 5u
#define ComConf_ComSignal_Comp_error_code1_oACP_32E_oCAN00_b5915ac1_Rx 6u
#define ComConf_ComSignal_Comp_speed_of_compressor_oACP_32E_oCAN00_c033917a_Rx 7u
#define ComConf_ComSignal_Comp_work_status_oACP_32E_oCAN00_1667710c_Rx 8u
#define ComConf_ComSignal_Ecomp_CompIpt_V_oACP_327_oCAN00_c7006e5a_Rx 9u
#define ComConf_ComSignal_Ecomp_Complpt_A_oACP_327_oCAN00_ea282991_Rx 10u
#define ComConf_ComSignal_Ecomp_InvSoftwareVer_oACP_327_oCAN00_4030e33b_Rx 11u
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define ComConf_ComSignal_AC_max_perm_compressor_power_oITMS_350_oCAN00_ef8bdcbc_Tx 0u
#define ComConf_ComSignal_AllowOperation_Flag_oITMS_350_oCAN00_009f228c_Tx 1u
#define ComConf_ComSignal_TgtSpd_rpm_oITMS_350_oCAN00_b9dd7dcf_Tx     2u
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define ComConf_ComIPduGroup_ITMS_oCAN00_Rx_06702e0c                  0u
#define ComConf_ComIPduGroup_ITMS_oCAN00_Tx_502a898a                  1u
/**\} */
...
#define Com_GetSizeOfConstValueUInt8OfPCConfig()                      3u  /**< the number of accomplishable value elements in Com_ConstValueUInt8 */
...
#define Com_GetSizeOfRxAccessInfoIndOfPCConfig()                      12u  /**< the number of accomplishable value elements in Com_RxAccessInfoInd */
#define Com_GetSizeOfRxAccessInfoOfPCConfig()                         12u  /**< the number of accomplishable value elements in Com_RxAccessInfo */
...
#define Com_GetSizeOfRxSigBufferUInt8OfPCConfig()                     7u  /**< the number of accomplishable value elements in Com_RxSigBufferUInt8 */
#define Com_GetSizeOfRxSigInfoOfPCConfig()                            12u  /**< the number of accomplishable value elements in Com_RxSigInfo */
...
#define Com_GetTimePeriodOfTxModeFalse(Index)                         ((Com_TimePeriodOfTxModeFalseType)((((Com_TimePeriodOfTxModeFalseType)(Index)) + 100u)))  /**< Cycle time factor. */
#define Com_GetMinimumDelayOfTxModeInfo(Index)                        ((Com_MinimumDelayOfTxModeInfoType)((((Com_MinimumDelayOfTxModeInfoType)(Index)) + 2u)))  /**< Minimum delay factor of the Tx I-PDU. */
...
#define Com_GetTimePeriodOfTxModeTrue(Index)                          ((Com_TimePeriodOfTxModeTrueType)((((Com_TimePeriodOfTxModeTrueType)(Index)) + 100u)))  /**< Cycle time factor. */
#define Com_GetPduGrpVectorEndIdxOfTxPduGrpInfo(Index)                ((Com_PduGrpVectorEndIdxOfTxPduGrpInfoType)((((Com_PduGrpVectorEndIdxOfTxPduGrpInfoType)(Index)) + 1u)))  /**< the end index of the 0:n relation pointing to Com_PduGrpVector */
#define Com_GetPduGrpVectorStartIdxOfTxPduGrpInfo(Index)              ((Com_PduGrpVectorStartIdxOfTxPduGrpInfoType)((Index)))  /**< the start index of the 0:n relation pointing to Com_PduGrpVector */
...
#define Com_GetBytePositionOfTxSigInfo(Index)                         ((Com_BytePositionOfTxSigInfoType)((Com_GetTxBufferEndIdxOfTxSigInfo(Index) - 1u)))  /**< Little endian byte position of the signal or group signal within the I-PDU. */
#define Com_GetStartByteInPduPositionOfTxSigInfo(Index)               Com_GetTxBufferStartIdxOfTxSigInfo(Index)  /**< Start Byte position of the signal or group signal within the I-PDU. */
...
{
  Com_HandleRxPduDeferredType ACP_32E_oCAN00_11d3b5e8_Rx;
  Com_HandleRxPduDeferredType ACP_327_oCAN00_ffa62305_Rx;
  Com_HandleRxPduDeferredType B_RLS_oCAN00_6419d093_Rx;
...
{
  Com_RxDefPduBufferType ACP_32E_oCAN00_11d3b5e8_Rx[8];
  Com_RxDefPduBufferType ACP_327_oCAN00_ffa62305_Rx[8];
  Com_RxDefPduBufferType B_RLS_oCAN00_6419d093_Rx[8];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Com_ConstValueUInt8Type, COM_CONST) Com_ConstValueUInt8[3];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Com_RxAccessInfoType, COM_CONST) Com_RxAccessInfo[12];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Com_RxAccessInfoIndType, COM_CONST) Com_RxAccessInfoInd[12];
#define COM_STOP_SEC_CONST_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Com_RxSigInfoType, COM_CONST) Com_RxSigInfo[12];
#define COM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(Com_RxSigBufferUInt8Type, COM_VAR_NOINIT) Com_RxSigBufferUInt8[7];
#define COM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
