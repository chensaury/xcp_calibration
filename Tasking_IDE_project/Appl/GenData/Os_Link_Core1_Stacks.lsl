...
group OS_STACK_OSCORE1_ERROR_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  ...
  reserved ".pad.OS_STACK_OSCORE1_ERROR_VAR_NOINIT" (size=16);
}
"_OS_STACK_OSCORE1_ERROR_VAR_NOINIT_START" = "_lc_gb_OS_STACK_OSCORE1_ERROR_VAR_NOINIT_GROUP";
"_OS_STACK_OSCORE1_ERROR_VAR_NOINIT_END" = "_lc_ub__pad_OS_STACK_OSCORE1_ERROR_VAR_NOINIT";
...
group OS_STACK_OSCORE1_TASK_PRIO20_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  ...
  reserved ".pad.OS_STACK_OSCORE1_TASK_PRIO20_VAR_NOINIT" (size=16);
}
"_OS_STACK_OSCORE1_TASK_PRIO20_VAR_NOINIT_START" = "_lc_gb_OS_STACK_OSCORE1_TASK_PRIO20_VAR_NOINIT_GROUP";
"_OS_STACK_OSCORE1_TASK_PRIO20_VAR_NOINIT_END" = "_lc_ub__pad_OS_STACK_OSCORE1_TASK_PRIO20_VAR_NOINIT";
...
group OS_STACK_OSCORE1_TASK_PRIO50_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  ...
  reserved ".pad.OS_STACK_OSCORE1_TASK_PRIO50_VAR_NOINIT" (size=16);
}
"_OS_STACK_OSCORE1_TASK_PRIO50_VAR_NOINIT_START" = "_lc_gb_OS_STACK_OSCORE1_TASK_PRIO50_VAR_NOINIT_GROUP";
"_OS_STACK_OSCORE1_TASK_PRIO50_VAR_NOINIT_END" = "_lc_ub__pad_OS_STACK_OSCORE1_TASK_PRIO50_VAR_NOINIT";
