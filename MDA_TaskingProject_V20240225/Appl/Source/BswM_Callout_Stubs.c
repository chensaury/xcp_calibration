 ...
 * DO NOT CHANGE THIS COMMENT!           </USERBLOCK>                                       DO NOT CHANGE THIS COMMENT!
 *********************************************************************************************************************/
  ComM_StateType CN_CAN00_8c3ac689 = COMM_NO_COM_NO_PENDING_REQUEST;
  ComM_StateType CN_Schaeffler_MDA_CANFD_c149c45e = COMM_NO_COM_NO_PENDING_REQUEST;
  ComM_StateType CN_Schaeffler_MotorFL_CANFD_b5523491 = COMM_NO_COM_NO_PENDING_REQUEST;
  ComM_StateType CN_Schaeffler_MotorRR_CANFD_7a42ecd3 = COMM_NO_COM_NO_PENDING_REQUEST;
  ComM_StateType CN_Schaeffler_MotorRL_CANFD_4da30b40 = COMM_NO_COM_NO_PENDING_REQUEST;
  ComM_StateType CN_Schaeffler_MotorFR_CANFD_82b3d302 = COMM_NO_COM_NO_PENDING_REQUEST;
  
  (void)ComM_GetState(ComMConf_ComMChannel_CN_CAN00_8c3ac689, &CN_CAN00_8c3ac689); /* SBSW_BSWM_FCTCALL_LOCALVAR */
  (void)ComM_GetState(ComMConf_ComMChannel_CN_Schaeffler_MDA_CANFD_c149c45e, &CN_Schaeffler_MDA_CANFD_c149c45e); /* SBSW_BSWM_FCTCALL_LOCALVAR */
  (void)ComM_GetState(ComMConf_ComMChannel_CN_Schaeffler_MotorFL_CANFD_b5523491, &CN_Schaeffler_MotorFL_CANFD_b5523491); /* SBSW_BSWM_FCTCALL_LOCALVAR */
  (void)ComM_GetState(ComMConf_ComMChannel_CN_Schaeffler_MotorRR_CANFD_7a42ecd3, &CN_Schaeffler_MotorRR_CANFD_7a42ecd3); /* SBSW_BSWM_FCTCALL_LOCALVAR */
  (void)ComM_GetState(ComMConf_ComMChannel_CN_Schaeffler_MotorRL_CANFD_4da30b40, &CN_Schaeffler_MotorRL_CANFD_4da30b40); /* SBSW_BSWM_FCTCALL_LOCALVAR */
  (void)ComM_GetState(ComMConf_ComMChannel_CN_Schaeffler_MotorFR_CANFD_82b3d302, &CN_Schaeffler_MotorFR_CANFD_82b3d302); /* SBSW_BSWM_FCTCALL_LOCALVAR */
  
  if((CN_CAN00_8c3ac689 != COMM_NO_COM_NO_PENDING_REQUEST) || (CN_Schaeffler_MDA_CANFD_c149c45e != COMM_NO_COM_NO_PENDING_REQUEST) || (CN_Schaeffler_MotorFL_CANFD_b5523491 != COMM_NO_COM_NO_PENDING_REQUEST) || (CN_Schaeffler_MotorRR_CANFD_7a42ecd3 != COMM_NO_COM_NO_PENDING_REQUEST) || (CN_Schaeffler_MotorRL_CANFD_4da30b40 != COMM_NO_COM_NO_PENDING_REQUEST) || (CN_Schaeffler_MotorFR_CANFD_82b3d302 != COMM_NO_COM_NO_PENDING_REQUEST))
  {
 ...
 *********************************************************************************************************************/
  ...
  ComM_RequestComMode(4, COMM_FULL_COMMUNICATION);
  ComM_RequestComMode(5, COMM_FULL_COMMUNICATION);
