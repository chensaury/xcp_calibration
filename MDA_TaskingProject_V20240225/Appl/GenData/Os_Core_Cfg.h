...
# define OS_CFG_NUM_ISRLEVELS                                    (36uL)

/*! Number of all spinlocks. */
# define OS_CFG_NUM_SYSTEM_SPINLOCKS                             (8uL)
...
# define OS_CFG_NUM_CORE_OSCORE0_STACKS           (16uL)
# define OS_CFG_NUM_CORE_OSCORE0_ISRS             (36uL)
