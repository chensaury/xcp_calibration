...
VAR(MotActFR, RTE_VAR_INIT_NOCACHE) Rte_CtMotor_FR_PpMotFRAct_MotFRAct = {
...
FUNC(void, RTE_CODE) Rte_InitMemory_SystemApplication_OsCore2(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  ...
  Rte_CtMotor_FR_PpMotFRAct_MotFRAct = Rte_C_MotActFR_0;
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_CtMotor_FR_PpMotFRAct_MotFRAct(P2CONST(MotActFR, AUTOMATIC, RTE_CTMOTOR_FR_APPL_DATA) data) /* PRQA S 0850, 1505 */ /* MD_MSR_19.8, MD_MSR_8.10 */
{
  Std_ReturnType ret = RTE_E_OK;

  (void)GetSpinlock(Rte_Spinlock_CtMotor_FR_PpMotFRAct_MotFRAct);
  Rte_CtMotor_FR_PpMotFRAct_MotFRAct = *(data);
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_CtMotor_FR_PpMotTgtOutFR_MotTgtOutFR(P2VAR(MotTgtOutFR, AUTOMATIC, RTE_CTMOTOR_FR_APPL_VAR) data) /* PRQA S 0850, 3673, 1505 */ /* MD_MSR_19.8, MD_Rte_Qac, MD_MSR_8.10 */
{
  Std_ReturnType ret = RTE_E_OK;

  (void)GetSpinlock(Rte_Spinlock_CtMDA_Control_Logic_PpMotTgtOutFR_MotTgtOutFR);
  *(data) = Rte_CtMDA_Control_Logic_PpMotTgtOutFR_MotTgtOutFR;
 ...
 *********************************************************************************************************************/
TASK(APP_Task_Core2) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
 ...
 *********************************************************************************************************************/
TASK(SchM_Core2) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
