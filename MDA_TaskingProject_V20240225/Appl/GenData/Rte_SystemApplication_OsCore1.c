...
VAR(MotActFL, RTE_VAR_INIT_NOCACHE) Rte_CtMotor_FL_PpMotFLAct_MotFLAct = {
...
FUNC(void, RTE_CODE) Rte_InitMemory_SystemApplication_OsCore1(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  ...
  Rte_CtMotor_FL_PpMotFLAct_MotFLAct = Rte_C_MotActFL_0;
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_CtMotor_FL_PpMotFLAct_MotFLAct(P2CONST(MotActFL, AUTOMATIC, RTE_CTMOTOR_FL_APPL_DATA) data) /* PRQA S 0850, 1505 */ /* MD_MSR_19.8, MD_MSR_8.10 */
{
  Std_ReturnType ret = RTE_E_OK;

  (void)GetSpinlock(Rte_Spinlock_CtMotor_FL_PpMotFLAct_MotFLAct);
  Rte_CtMotor_FL_PpMotFLAct_MotFLAct = *(data);
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_CtMotor_FL_PpMotTgtOutFL_MotTgtOutFL(P2VAR(MotTgtOutFL, AUTOMATIC, RTE_CTMOTOR_FL_APPL_VAR) data) /* PRQA S 0850, 3673, 1505 */ /* MD_MSR_19.8, MD_Rte_Qac, MD_MSR_8.10 */
{
  Std_ReturnType ret = RTE_E_OK;

  (void)GetSpinlock(Rte_Spinlock_CtMDA_Control_Logic_PpMotTgtOutFL_MotTgtOutFL);
  *(data) = Rte_CtMDA_Control_Logic_PpMotTgtOutFL_MotTgtOutFL;
