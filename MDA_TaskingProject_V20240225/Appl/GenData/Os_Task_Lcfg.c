...
/*! Dynamic task data: Core_OsTask_CDD */
OS_LOCAL VAR(Os_TaskType, OS_VAR_NOINIT) OsCfg_Task_Core_OsTask_CDD_Dyn;

/*! Dynamic task data: Core_OsTask_IOHW */
OS_LOCAL VAR(Os_TaskType, OS_VAR_NOINIT) OsCfg_Task_Core_OsTask_IOHW_Dyn;

/*! Dynamic task data: Core_OsTask_PSI5 */
OS_LOCAL VAR(Os_TaskType, OS_VAR_NOINIT) OsCfg_Task_Core_OsTask_PSI5_Dyn;

/*! Dynamic task data: Core_OsTask_PT2000 */
OS_LOCAL VAR(Os_TaskType, OS_VAR_NOINIT) OsCfg_Task_Core_OsTask_PT2000_Dyn;
...
CONST(Os_TaskConfigType, OS_CONST) OsCfg_Task_APP_Task_Core0 =
{
  /* .Thread                = */
  {
    ...
    /* .Stack                 = */ &OsCfg_Stack_OsCore0_Task_Prio60,
...
/*! Task configuration data: Core_OsTask_CDD */
CONST(Os_TaskConfigType, OS_CONST) OsCfg_Task_Core_OsTask_CDD =
{
  /* .Thread                = */
  {
    /* .ContextConfig         = */ &OsCfg_Hal_Context_Core_OsTask_CDD,
    /* .Context               = */ &OsCfg_Hal_Context_Core_OsTask_CDD_Dyn,
    /* .Stack                 = */ &OsCfg_Stack_OsCore0_Task_Prio56,
    /* .Dyn                   = */ OS_TASK_CASTDYN_TASK_2_THREAD(OsCfg_Task_Core_OsTask_CDD_Dyn),
    /* .OwnerApplication      = */ &OsCfg_App_SystemApplication_OsCore0,
    /* .Core                  = */ &OsCfg_Core_OsCore0,
    /* .IntApiState           = */ &OsCfg_Core_OsCore0_Dyn.IntApiState,
    /* .TimeProtConfig        = */ NULL_PTR,
...
/*! Task configuration data: Core_OsTask_IOHW */
CONST(Os_TaskConfigType, OS_CONST) OsCfg_Task_Core_OsTask_IOHW =
{
  /* .Thread                = */
  {
    /* .ContextConfig         = */ &OsCfg_Hal_Context_Core_OsTask_IOHW,
    /* .Context               = */ &OsCfg_Hal_Context_Core_OsTask_IOHW_Dyn,
    /* .Stack                 = */ &OsCfg_Stack_Core_OsTask_IOHW,
    /* .Dyn                   = */ OS_TASK_CASTDYN_TASK_2_THREAD(OsCfg_Task_Core_OsTask_IOHW_Dyn),
    /* .OwnerApplication      = */ &OsCfg_App_SystemApplication_OsCore0,
    /* .Core                  = */ &OsCfg_Core_OsCore0,
    /* .IntApiState           = */ &OsCfg_Core_OsCore0_Dyn.IntApiState,
    /* .TimeProtConfig        = */ NULL_PTR,
...
/*! Task configuration data: Core_OsTask_PSI5 */
CONST(Os_TaskConfigType, OS_CONST) OsCfg_Task_Core_OsTask_PSI5 =
{
  /* .Thread                = */
  {
    /* .ContextConfig         = */ &OsCfg_Hal_Context_Core_OsTask_PSI5,
    /* .Context               = */ &OsCfg_Hal_Context_Core_OsTask_PSI5_Dyn,
    /* .Stack                 = */ &OsCfg_Stack_OsCore0_Task_Prio59,
    /* .Dyn                   = */ OS_TASK_CASTDYN_TASK_2_THREAD(OsCfg_Task_Core_OsTask_PSI5_Dyn),
    /* .OwnerApplication      = */ &OsCfg_App_SystemApplication_OsCore0,
    /* .Core                  = */ &OsCfg_Core_OsCore0,
    /* .IntApiState           = */ &OsCfg_Core_OsCore0_Dyn.IntApiState,
    /* .TimeProtConfig        = */ NULL_PTR,
...
/*! Task configuration data: Core_OsTask_PT2000 */
CONST(Os_TaskConfigType, OS_CONST) OsCfg_Task_Core_OsTask_PT2000 =
{
  /* .Thread                = */
  {
    /* .ContextConfig         = */ &OsCfg_Hal_Context_Core_OsTask_PT2000,
    /* .Context               = */ &OsCfg_Hal_Context_Core_OsTask_PT2000_Dyn,
    /* .Stack                 = */ &OsCfg_Stack_Core_OsTask_PT2000,
    /* .Dyn                   = */ OS_TASK_CASTDYN_TASK_2_THREAD(OsCfg_Task_Core_OsTask_PT2000_Dyn),
    /* .OwnerApplication      = */ &OsCfg_App_SystemApplication_OsCore0,
    /* .Core                  = */ &OsCfg_Core_OsCore0,
    /* .IntApiState           = */ &OsCfg_Core_OsCore0_Dyn.IntApiState,
    /* .TimeProtConfig        = */ NULL_PTR,
