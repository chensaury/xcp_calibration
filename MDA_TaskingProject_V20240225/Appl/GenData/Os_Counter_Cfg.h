...
/*! Number of counter jobs: SystemTimer0 */
# define OS_CFG_NUM_COUNTER_SYSTEMTIMER0_JOBS     (11uL)

/*! Number of counter jobs: SystemTimer1 */
# define OS_CFG_NUM_COUNTER_SYSTEMTIMER1_JOBS     (2uL)

/*! Number of counter jobs: SystemTimer2 */
# define OS_CFG_NUM_COUNTER_SYSTEMTIMER2_JOBS     (2uL)

/*! Number of counter jobs: SystemTimer3 */
# define OS_CFG_NUM_COUNTER_SYSTEMTIMER3_JOBS     (2uL)

/*! Number of counter jobs: SystemTimer4 */
# define OS_CFG_NUM_COUNTER_SYSTEMTIMER4_JOBS     (2uL)

/*! Number of counter jobs: SystemTimer5 */
# define OS_CFG_NUM_COUNTER_SYSTEMTIMER5_JOBS     (2uL)
