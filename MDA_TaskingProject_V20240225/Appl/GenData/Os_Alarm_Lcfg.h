...
extern CONST(Os_AlarmActivateTaskConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE_CtCDD_CtCDD;

/*! Alarm configuration data: Rte_Al_TE_CtIoHardWare_Adc_Write */
extern CONST(Os_AlarmSetEventConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE_CtIoHardWare_Adc_Write;

/*! Alarm configuration data: Rte_Al_TE_CtMDA_Control_Logic_MDA_Control_Logic */
extern CONST(Os_AlarmActivateTaskConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE_CtMDA_Control_Logic_MDA_Control_Logic;

/*! Alarm configuration data: Rte_Al_TE_CtPSI5_Handler_PSI5MAIN_HD */
extern CONST(Os_AlarmActivateTaskConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE_CtPSI5_Handler_PSI5MAIN_HD;

/*! Alarm configuration data: Rte_Al_TE_CtPT2000_Handler_PT2000_Diag_HD */
extern CONST(Os_AlarmSetEventConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE_CtPT2000_Handler_PT2000_Diag_HD;

/*! Alarm configuration data: Rte_Al_TE_CtPT2000_Handler_PT2000_Main_HD */
extern CONST(Os_AlarmSetEventConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE_CtPT2000_Handler_PT2000_Main_HD;

/*! Alarm configuration data: Rte_Al_TE_CtPWM_Handler_PWM_SET */
extern CONST(Os_AlarmSetEventConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE_CtPWM_Handler_PWM_SET;
...
extern CONST(Os_AlarmActivateTaskConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE_CtMotor_FL_CpApMotor_FL;
...
extern CONST(Os_AlarmActivateTaskConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE_CtMotor_FR_CpApMotor_FR;
...
extern CONST(Os_AlarmActivateTaskConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE_CtMotor_RL_CpApMotor_RL;
...
extern CONST(Os_AlarmActivateTaskConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE_CtMotor_RR_CpApMotor_RR;
...
extern CONST(Os_AlarmActivateTaskConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE_Core5swc_Runnable;
