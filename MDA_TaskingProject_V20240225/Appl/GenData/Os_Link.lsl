...
/* Cores: [OsCore0, OsCore1] */
#if defined ( OS_LINK_VAR ) || defined ( OS_LINK_VAR_CORESHARED ) || defined ( OS_LINK_VAR_CORESHARED_0X00000003 ) || defined ( OS_LINK_VAR_CORESHARED_0X00000003_FAR )
if (exists(".bss.OS_CORESHARED_0X00000003_VAR_NOCACHE_NOINIT"))
{
  group OS_CORESHARED_0X00000003_VAR_NOCACHE_NOINIT_GROUP(ordered, contiguous, fill, align=8)
  {
    section "OS_CORESHARED_0X00000003_VAR_NOCACHE_NOINIT_SECTION" (blocksize=2, attributes=rw)
    {
      select ".bss.OS_CORESHARED_0X00000003_VAR_NOCACHE_NOINIT";
    }
    reserved ".pad.OS_CORESHARED_0X00000003_VAR_NOCACHE_NOINIT" (size=16);
  }
  "_OS_CORESHARED_0X00000003_VAR_NOCACHE_NOINIT_START" = "_lc_gb_OS_CORESHARED_0X00000003_VAR_NOCACHE_NOINIT_GROUP";
  "_OS_CORESHARED_0X00000003_VAR_NOCACHE_NOINIT_END" = "_lc_ub__pad_OS_CORESHARED_0X00000003_VAR_NOCACHE_NOINIT";
}
else
{
  "_OS_CORESHARED_0X00000003_VAR_NOCACHE_NOINIT_START" = 0;
  "_OS_CORESHARED_0X00000003_VAR_NOCACHE_NOINIT_END" = 0;
}
#endif

#if defined ( OS_LINK_VAR ) || defined ( OS_LINK_VAR_CORESHARED ) || defined ( OS_LINK_VAR_CORESHARED_0X00000003 ) || defined ( OS_LINK_VAR_CORESHARED_0X00000003_NEAR )
if (exists(".bss.OS_CORESHARED_0X00000003_VAR_FAST_NOCACHE_NOINIT"))
{
  group OS_CORESHARED_0X00000003_VAR_FAST_NOCACHE_NOINIT_GROUP(ordered, contiguous, fill, align=8)
  {
    section "OS_CORESHARED_0X00000003_VAR_FAST_NOCACHE_NOINIT_SECTION" (blocksize=2, attributes=rw)
    {
      select ".bss.OS_CORESHARED_0X00000003_VAR_FAST_NOCACHE_NOINIT";
    }
    reserved ".pad.OS_CORESHARED_0X00000003_VAR_FAST_NOCACHE_NOINIT" (size=16);
  }
  "_OS_CORESHARED_0X00000003_VAR_FAST_NOCACHE_NOINIT_START" = "_lc_gb_OS_CORESHARED_0X00000003_VAR_FAST_NOCACHE_NOINIT_GROUP";
  "_OS_CORESHARED_0X00000003_VAR_FAST_NOCACHE_NOINIT_END" = "_lc_ub__pad_OS_CORESHARED_0X00000003_VAR_FAST_NOCACHE_NOINIT";
}
else
{
  "_OS_CORESHARED_0X00000003_VAR_FAST_NOCACHE_NOINIT_START" = 0;
  "_OS_CORESHARED_0X00000003_VAR_FAST_NOCACHE_NOINIT_END" = 0;
}
#endif

#ifdef OS_LINK_VAR_CORESHARED_0X00000003_NEAR
# undef OS_LINK_VAR_CORESHARED_0X00000003_NEAR
#endif

#ifdef OS_LINK_VAR_CORESHARED_0X00000003_FAR
# undef OS_LINK_VAR_CORESHARED_0X00000003_FAR
#endif

#ifdef OS_LINK_VAR_CORESHARED_0X00000003
# undef OS_LINK_VAR_CORESHARED_0X00000003
#endif

/* Cores: [OsCore0, OsCore2] */
#if defined ( OS_LINK_VAR ) || defined ( OS_LINK_VAR_CORESHARED ) || defined ( OS_LINK_VAR_CORESHARED_0X00000005 ) || defined ( OS_LINK_VAR_CORESHARED_0X00000005_FAR )
if (exists(".bss.OS_CORESHARED_0X00000005_VAR_NOCACHE_NOINIT"))
{
  group OS_CORESHARED_0X00000005_VAR_NOCACHE_NOINIT_GROUP(ordered, contiguous, fill, align=8)
  {
    section "OS_CORESHARED_0X00000005_VAR_NOCACHE_NOINIT_SECTION" (blocksize=2, attributes=rw)
    {
      select ".bss.OS_CORESHARED_0X00000005_VAR_NOCACHE_NOINIT";
    }
    reserved ".pad.OS_CORESHARED_0X00000005_VAR_NOCACHE_NOINIT" (size=16);
  }
  "_OS_CORESHARED_0X00000005_VAR_NOCACHE_NOINIT_START" = "_lc_gb_OS_CORESHARED_0X00000005_VAR_NOCACHE_NOINIT_GROUP";
  "_OS_CORESHARED_0X00000005_VAR_NOCACHE_NOINIT_END" = "_lc_ub__pad_OS_CORESHARED_0X00000005_VAR_NOCACHE_NOINIT";
}
else
{
  "_OS_CORESHARED_0X00000005_VAR_NOCACHE_NOINIT_START" = 0;
  "_OS_CORESHARED_0X00000005_VAR_NOCACHE_NOINIT_END" = 0;
}
#endif

#if defined ( OS_LINK_VAR ) || defined ( OS_LINK_VAR_CORESHARED ) || defined ( OS_LINK_VAR_CORESHARED_0X00000005 ) || defined ( OS_LINK_VAR_CORESHARED_0X00000005_NEAR )
if (exists(".bss.OS_CORESHARED_0X00000005_VAR_FAST_NOCACHE_NOINIT"))
{
  group OS_CORESHARED_0X00000005_VAR_FAST_NOCACHE_NOINIT_GROUP(ordered, contiguous, fill, align=8)
  {
    section "OS_CORESHARED_0X00000005_VAR_FAST_NOCACHE_NOINIT_SECTION" (blocksize=2, attributes=rw)
    {
      select ".bss.OS_CORESHARED_0X00000005_VAR_FAST_NOCACHE_NOINIT";
    }
    reserved ".pad.OS_CORESHARED_0X00000005_VAR_FAST_NOCACHE_NOINIT" (size=16);
  }
  "_OS_CORESHARED_0X00000005_VAR_FAST_NOCACHE_NOINIT_START" = "_lc_gb_OS_CORESHARED_0X00000005_VAR_FAST_NOCACHE_NOINIT_GROUP";
  "_OS_CORESHARED_0X00000005_VAR_FAST_NOCACHE_NOINIT_END" = "_lc_ub__pad_OS_CORESHARED_0X00000005_VAR_FAST_NOCACHE_NOINIT";
}
else
{
  "_OS_CORESHARED_0X00000005_VAR_FAST_NOCACHE_NOINIT_START" = 0;
  "_OS_CORESHARED_0X00000005_VAR_FAST_NOCACHE_NOINIT_END" = 0;
}
#endif

#ifdef OS_LINK_VAR_CORESHARED_0X00000005_NEAR
# undef OS_LINK_VAR_CORESHARED_0X00000005_NEAR
#endif

#ifdef OS_LINK_VAR_CORESHARED_0X00000005_FAR
# undef OS_LINK_VAR_CORESHARED_0X00000005_FAR
#endif

#ifdef OS_LINK_VAR_CORESHARED_0X00000005
# undef OS_LINK_VAR_CORESHARED_0X00000005
#endif

/* Cores: [OsCore0, OsCore3] */
#if defined ( OS_LINK_VAR ) || defined ( OS_LINK_VAR_CORESHARED ) || defined ( OS_LINK_VAR_CORESHARED_0X00000009 ) || defined ( OS_LINK_VAR_CORESHARED_0X00000009_FAR )
if (exists(".bss.OS_CORESHARED_0X00000009_VAR_NOCACHE_NOINIT"))
{
  group OS_CORESHARED_0X00000009_VAR_NOCACHE_NOINIT_GROUP(ordered, contiguous, fill, align=8)
  {
    section "OS_CORESHARED_0X00000009_VAR_NOCACHE_NOINIT_SECTION" (blocksize=2, attributes=rw)
    {
      select ".bss.OS_CORESHARED_0X00000009_VAR_NOCACHE_NOINIT";
    }
    reserved ".pad.OS_CORESHARED_0X00000009_VAR_NOCACHE_NOINIT" (size=16);
  }
  "_OS_CORESHARED_0X00000009_VAR_NOCACHE_NOINIT_START" = "_lc_gb_OS_CORESHARED_0X00000009_VAR_NOCACHE_NOINIT_GROUP";
  "_OS_CORESHARED_0X00000009_VAR_NOCACHE_NOINIT_END" = "_lc_ub__pad_OS_CORESHARED_0X00000009_VAR_NOCACHE_NOINIT";
}
else
{
  "_OS_CORESHARED_0X00000009_VAR_NOCACHE_NOINIT_START" = 0;
  "_OS_CORESHARED_0X00000009_VAR_NOCACHE_NOINIT_END" = 0;
}
#endif

#if defined ( OS_LINK_VAR ) || defined ( OS_LINK_VAR_CORESHARED ) || defined ( OS_LINK_VAR_CORESHARED_0X00000009 ) || defined ( OS_LINK_VAR_CORESHARED_0X00000009_NEAR )
if (exists(".bss.OS_CORESHARED_0X00000009_VAR_FAST_NOCACHE_NOINIT"))
{
  group OS_CORESHARED_0X00000009_VAR_FAST_NOCACHE_NOINIT_GROUP(ordered, contiguous, fill, align=8)
  {
    section "OS_CORESHARED_0X00000009_VAR_FAST_NOCACHE_NOINIT_SECTION" (blocksize=2, attributes=rw)
    {
      select ".bss.OS_CORESHARED_0X00000009_VAR_FAST_NOCACHE_NOINIT";
    }
    reserved ".pad.OS_CORESHARED_0X00000009_VAR_FAST_NOCACHE_NOINIT" (size=16);
  }
  "_OS_CORESHARED_0X00000009_VAR_FAST_NOCACHE_NOINIT_START" = "_lc_gb_OS_CORESHARED_0X00000009_VAR_FAST_NOCACHE_NOINIT_GROUP";
  "_OS_CORESHARED_0X00000009_VAR_FAST_NOCACHE_NOINIT_END" = "_lc_ub__pad_OS_CORESHARED_0X00000009_VAR_FAST_NOCACHE_NOINIT";
}
else
{
  "_OS_CORESHARED_0X00000009_VAR_FAST_NOCACHE_NOINIT_START" = 0;
  "_OS_CORESHARED_0X00000009_VAR_FAST_NOCACHE_NOINIT_END" = 0;
}
#endif

#ifdef OS_LINK_VAR_CORESHARED_0X00000009_NEAR
# undef OS_LINK_VAR_CORESHARED_0X00000009_NEAR
#endif

#ifdef OS_LINK_VAR_CORESHARED_0X00000009_FAR
# undef OS_LINK_VAR_CORESHARED_0X00000009_FAR
#endif

#ifdef OS_LINK_VAR_CORESHARED_0X00000009
# undef OS_LINK_VAR_CORESHARED_0X00000009
#endif

/* Cores: [OsCore0, OsCore4] */
#if defined ( OS_LINK_VAR ) || defined ( OS_LINK_VAR_CORESHARED ) || defined ( OS_LINK_VAR_CORESHARED_0X00000011 ) || defined ( OS_LINK_VAR_CORESHARED_0X00000011_FAR )
if (exists(".bss.OS_CORESHARED_0X00000011_VAR_NOCACHE_NOINIT"))
{
  group OS_CORESHARED_0X00000011_VAR_NOCACHE_NOINIT_GROUP(ordered, contiguous, fill, align=8)
  {
    section "OS_CORESHARED_0X00000011_VAR_NOCACHE_NOINIT_SECTION" (blocksize=2, attributes=rw)
    {
      select ".bss.OS_CORESHARED_0X00000011_VAR_NOCACHE_NOINIT";
    }
    reserved ".pad.OS_CORESHARED_0X00000011_VAR_NOCACHE_NOINIT" (size=16);
  }
  "_OS_CORESHARED_0X00000011_VAR_NOCACHE_NOINIT_START" = "_lc_gb_OS_CORESHARED_0X00000011_VAR_NOCACHE_NOINIT_GROUP";
  "_OS_CORESHARED_0X00000011_VAR_NOCACHE_NOINIT_END" = "_lc_ub__pad_OS_CORESHARED_0X00000011_VAR_NOCACHE_NOINIT";
}
else
{
  "_OS_CORESHARED_0X00000011_VAR_NOCACHE_NOINIT_START" = 0;
  "_OS_CORESHARED_0X00000011_VAR_NOCACHE_NOINIT_END" = 0;
}
#endif

#if defined ( OS_LINK_VAR ) || defined ( OS_LINK_VAR_CORESHARED ) || defined ( OS_LINK_VAR_CORESHARED_0X00000011 ) || defined ( OS_LINK_VAR_CORESHARED_0X00000011_NEAR )
if (exists(".bss.OS_CORESHARED_0X00000011_VAR_FAST_NOCACHE_NOINIT"))
{
  group OS_CORESHARED_0X00000011_VAR_FAST_NOCACHE_NOINIT_GROUP(ordered, contiguous, fill, align=8)
  {
    section "OS_CORESHARED_0X00000011_VAR_FAST_NOCACHE_NOINIT_SECTION" (blocksize=2, attributes=rw)
    {
      select ".bss.OS_CORESHARED_0X00000011_VAR_FAST_NOCACHE_NOINIT";
    }
    reserved ".pad.OS_CORESHARED_0X00000011_VAR_FAST_NOCACHE_NOINIT" (size=16);
  }
  "_OS_CORESHARED_0X00000011_VAR_FAST_NOCACHE_NOINIT_START" = "_lc_gb_OS_CORESHARED_0X00000011_VAR_FAST_NOCACHE_NOINIT_GROUP";
  "_OS_CORESHARED_0X00000011_VAR_FAST_NOCACHE_NOINIT_END" = "_lc_ub__pad_OS_CORESHARED_0X00000011_VAR_FAST_NOCACHE_NOINIT";
}
else
{
  "_OS_CORESHARED_0X00000011_VAR_FAST_NOCACHE_NOINIT_START" = 0;
  "_OS_CORESHARED_0X00000011_VAR_FAST_NOCACHE_NOINIT_END" = 0;
}
#endif

#ifdef OS_LINK_VAR_CORESHARED_0X00000011_NEAR
# undef OS_LINK_VAR_CORESHARED_0X00000011_NEAR
#endif

#ifdef OS_LINK_VAR_CORESHARED_0X00000011_FAR
# undef OS_LINK_VAR_CORESHARED_0X00000011_FAR
#endif

#ifdef OS_LINK_VAR_CORESHARED_0X00000011
# undef OS_LINK_VAR_CORESHARED_0X00000011
#endif
