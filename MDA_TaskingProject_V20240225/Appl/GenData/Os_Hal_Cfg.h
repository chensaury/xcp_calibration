...
# define OS_ISR_ADC0SR0_ISR_LEVEL     (22)
# define OS_ISR_ADC1SR0_ISR_CORE      (0)
# define OS_ISR_ADC1SR0_ISR_LEVEL     (23)
# define OS_ISR_ADC2SR0_ISR_CORE      (0)
# define OS_ISR_ADC2SR0_ISR_LEVEL     (24)
# define OS_ISR_ADC3SR0_ISR_CORE      (0)
# define OS_ISR_ADC3SR0_ISR_LEVEL     (25)
# define OS_ISR_ADC8SR0_ISR_CORE      (0)
# define OS_ISR_ADC8SR0_ISR_LEVEL     (48)
# define OS_ISR_CANISR_0_CORE      (1)
# define OS_ISR_CANISR_0_LEVEL     (21)
# define OS_ISR_CANISR_1_CORE      (2)
# define OS_ISR_CANISR_1_LEVEL     (66)
# define OS_ISR_CANISR_2_CORE      (3)
# define OS_ISR_CANISR_2_LEVEL     (67)
# define OS_ISR_CANISR_3_CORE      (4)
# define OS_ISR_CANISR_3_LEVEL     (68)
# define OS_ISR_CANISR_4_CORE      (0)
# define OS_ISR_CANISR_4_LEVEL     (69)
# define OS_ISR_CANISR_5_CORE      (0)
# define OS_ISR_CANISR_5_LEVEL     (49)
...
# define OS_ISR_DMACH0SR_ISR_CORE      (0)
# define OS_ISR_DMACH0SR_ISR_LEVEL     (26)
# define OS_ISR_DMACH3SR_ISR_CORE      (0)
# define OS_ISR_DMACH3SR_ISR_LEVEL     (27)
# define OS_ISR_DMACH4SR_ISR_CORE      (0)
# define OS_ISR_DMACH4SR_ISR_LEVEL     (28)
# define OS_ISR_DMACH5SR_ISR_CORE      (0)
# define OS_ISR_DMACH5SR_ISR_LEVEL     (29)
# define OS_ISR_DMACH6SR_ISR_CORE      (0)
# define OS_ISR_DMACH6SR_ISR_LEVEL     (30)
# define OS_ISR_DMACH7SR_ISR_CORE      (0)
# define OS_ISR_DMACH7SR_ISR_LEVEL     (31)
# define OS_ISR_DMACH8SR_ISR_CORE      (0)
# define OS_ISR_DMACH8SR_ISR_LEVEL     (32)
# define OS_ISR_DMACH9SR_ISR_CORE      (0)
# define OS_ISR_DMACH9SR_ISR_LEVEL     (33)
# define OS_ISR_DMAERR0SR_ISR_CORE      (0)
# define OS_ISR_DMAERR0SR_ISR_LEVEL     (47)
# define OS_ISR_GTMATOM0SR0_ISR_CORE      (0)
# define OS_ISR_GTMATOM0SR0_ISR_LEVEL     (55)
# define OS_ISR_GTMATOM1SR0_ISR_CORE      (0)
# define OS_ISR_GTMATOM1SR0_ISR_LEVEL     (56)
# define OS_ISR_GTMATOM2SR0_ISR_CORE      (0)
# define OS_ISR_GTMATOM2SR0_ISR_LEVEL     (57)
# define OS_ISR_GTMATOM4SR0_ISR_CORE      (0)
# define OS_ISR_GTMATOM4SR0_ISR_LEVEL     (58)
# define OS_ISR_GTMTIM2SR3_ISR_CORE      (0)
# define OS_ISR_GTMTIM2SR3_ISR_LEVEL     (59)
# define OS_ISR_GTMTIM2SR5_ISR_CORE      (0)
# define OS_ISR_GTMTIM2SR5_ISR_LEVEL     (60)
# define OS_ISR_GTMTOM0SR0_ISR_CORE      (0)
# define OS_ISR_GTMTOM0SR0_ISR_LEVEL     (61)
# define OS_ISR_GTMTOM0SR1_ISR_CORE      (0)
# define OS_ISR_GTMTOM0SR1_ISR_LEVEL     (62)
# define OS_ISR_GTMTOM0SR2_ISR_CORE      (0)
# define OS_ISR_GTMTOM0SR2_ISR_LEVEL     (63)
# define OS_ISR_GTMTOM0SR3_ISR_CORE      (0)
# define OS_ISR_GTMTOM0SR3_ISR_LEVEL     (64)
# define OS_ISR_QSPI0ERR_ISR_CORE      (0)
# define OS_ISR_QSPI0ERR_ISR_LEVEL     (45)
# define OS_ISR_QSPI0PT_ISR_CORE      (0)
# define OS_ISR_QSPI0PT_ISR_LEVEL     (46)
# define OS_ISR_QSPI1ERR_ISR_CORE      (0)
# define OS_ISR_QSPI1ERR_ISR_LEVEL     (43)
# define OS_ISR_QSPI1PT_ISR_CORE      (0)
# define OS_ISR_QSPI1PT_ISR_LEVEL     (44)
# define OS_ISR_QSPI2ERR_ISR_CORE      (0)
# define OS_ISR_QSPI2ERR_ISR_LEVEL     (39)
# define OS_ISR_QSPI2PT_ISR_CORE      (0)
# define OS_ISR_QSPI2PT_ISR_LEVEL     (40)
# define OS_ISR_QSPI3ERR_ISR_CORE      (0)
# define OS_ISR_QSPI3ERR_ISR_LEVEL     (41)
# define OS_ISR_QSPI3PT_ISR_CORE      (0)
# define OS_ISR_QSPI3PT_ISR_LEVEL     (42)
