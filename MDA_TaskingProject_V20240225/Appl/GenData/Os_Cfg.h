...
# define Rte_Ev_Run_CtIoHardWare_Adc_Write     ((EventMaskType)1uLL)
# define Rte_Ev_Run_CtPT2000_Handler_PT2000_Diag_HD     ((EventMaskType)1uLL)
# define Rte_Ev_Run_CtPT2000_Handler_PT2000_Main_HD     ((EventMaskType)2uLL)
# define Rte_Ev_Run_CtPWM_Handler_PWM_SET     ((EventMaskType)2uLL)
