...
#include "Rte_Os_OsCore1_swc.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
FUNC(Std_ReturnType, Os_OsCore1_swc_CODE) TSC_Inline_Os_OsCore1_swc_GetCounterValue(CounterType parg0, P2VAR(TimeInMicrosecondsType, AUTOMATIC, RTE_OS_OSCORE1_SWC_APPL_VAR) Value) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
/**********************************************************************************************************************
...
FUNC(Std_ReturnType, Os_OsCore1_swc_CODE) TSC_Inline_Os_OsCore1_swc_GetElapsedValue(CounterType parg0, P2VAR(TimeInMicrosecondsType, AUTOMATIC, RTE_OS_OSCORE1_SWC_APPL_VAR) Value, P2VAR(TimeInMicrosecondsType, AUTOMATIC, RTE_OS_OSCORE1_SWC_APPL_VAR) ElapsedValue) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
