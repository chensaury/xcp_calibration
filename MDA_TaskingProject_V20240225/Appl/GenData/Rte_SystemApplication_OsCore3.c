 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_SystemApplication_OsCore3.c
...
VAR(MotActRL, RTE_VAR_INIT_NOCACHE) Rte_CtMotor_RL_PpMotRLAct_MotRLAct = {
...
FUNC(void, RTE_CODE) Rte_InitMemory_SystemApplication_OsCore3(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  ...
  Rte_CtMotor_RL_PpMotRLAct_MotRLAct = Rte_C_MotActRL_0;
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_CtMotor_RL_PpMotRLAct_MotRLAct(P2CONST(MotActRL, AUTOMATIC, RTE_CTMOTOR_RL_APPL_DATA) data) /* PRQA S 0850, 1505 */ /* MD_MSR_19.8, MD_MSR_8.10 */
{
  Std_ReturnType ret = RTE_E_OK;

  (void)GetSpinlock(Rte_Spinlock_CtMotor_RL_PpMotRLAct_MotRLAct);
  Rte_CtMotor_RL_PpMotRLAct_MotRLAct = *(data);
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_CtMotor_RL_PpMotTgtOutRL_MotTgtOutRL(P2VAR(MotTgtOutRL, AUTOMATIC, RTE_CTMOTOR_RL_APPL_VAR) data) /* PRQA S 0850, 3673, 1505 */ /* MD_MSR_19.8, MD_Rte_Qac, MD_MSR_8.10 */
{
  Std_ReturnType ret = RTE_E_OK;

  (void)GetSpinlock(Rte_Spinlock_CtMDA_Control_Logic_PpMotTgtOutRL_MotTgtOutRL);
  *(data) = Rte_CtMDA_Control_Logic_PpMotTgtOutRL_MotTgtOutRL;
 ...
 *********************************************************************************************************************/
TASK(APP_Task_Core3) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
 ...
 *********************************************************************************************************************/
TASK(SchM_Core3) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
