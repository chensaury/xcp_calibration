 ...
 *       License:  CBD1900078
 *
 *   Description:  Application header file for SW-C <Core5swc>
 *********************************************************************************************************************/
...
# ifndef RTE_CORE
#  define RTE_RUNNABLE_Runnable Runnable
# endif

FUNC(void, Core5swc_CODE) Runnable(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
