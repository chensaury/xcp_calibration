...
extern CONST(Os_TaskConfigType, OS_CONST) OsCfg_Task_Core_OsTask_CDD;

/*! Task configuration data: Core_OsTask_IOHW */
extern CONST(Os_TaskConfigType, OS_CONST) OsCfg_Task_Core_OsTask_IOHW;

/*! Task configuration data: Core_OsTask_PSI5 */
extern CONST(Os_TaskConfigType, OS_CONST) OsCfg_Task_Core_OsTask_PSI5;

/*! Task configuration data: Core_OsTask_PT2000 */
extern CONST(Os_TaskConfigType, OS_CONST) OsCfg_Task_Core_OsTask_PT2000;
