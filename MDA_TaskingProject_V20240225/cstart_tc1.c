...
#if ( 1>0 ) && ( defined _REGTC21X_H || defined _REGTC22X_H || defined _REGTC23X_ADAS_H || defined _REGTC23X_H )
#pragma message "This derivative only supports core 0"
#else
#if 1>1 && ( defined _REGTC26X_H || defined _REGTC26XB_H )
#pragma message "This derivative only supports core 0 and 1."
#else
#if ( 1>2 ) && !( defined _REGTC38X_H || defined _REGTC39X_H || defined _REGTC39XB_H || defined _REGUSERDEF162_H )
#pragma message "This derivative only supports core 0, 1 and 2"
#else
#if ( 1>3 ) && !( defined _REGTC39X_H || defined _REGTC39XB_H || defined _REGUSERDEF162_H )
...
static char argcv_tc1[__ARGCV_BUFSIZE_TC1] __align(4);
#pragma clear
...
static void inline reset_psw( void )
{
        ...
        value |= (__CDC_TC1 & 0x7f);    /* PSW.CDC call depth counter */
...
static void __noinline__ __noreturn__ __jump__ _start( void )
{
...
#ifdef __COMPAT_TC1
#if __COMPAT_TC1 != 0xf
        __mtcr(COMPAT, (~0x18|__COMPAT_TC1));
#endif
#endif
         ...
         */
#if __BIV_TC1_INIT
#if __BIV_SINGLE_TC1_INIT && (defined _REGUSERDEF16X_H || defined _REGUSERDEF162_H || defined _REGTC27X_H || defined _REGTC27XB_H || defined _REGTC27XC_H || defined _REGTC27XD_H || defined _REGTC26X_H  || defined _REGTC26XB_H || defined _REGTC29X_H)
        /*
...
#else
#if __BIV_8BYTE_TC1_INIT && (defined _REGUSERDEF16X_H || defined _REGUSERDEF162_H || defined _REGTC27X_H || defined _REGTC27XB_H || defined _REGTC27XC_H || defined _REGTC27XD_H || defined _REGTC26X_H || defined _REGTC26XB_H || defined _REGTC29X_H)
