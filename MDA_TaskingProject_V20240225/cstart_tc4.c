...
#if ( 4>0 ) && ( defined _REGTC21X_H || defined _REGTC22X_H || defined _REGTC23X_ADAS_H || defined _REGTC23X_H )
#pragma message "This derivative only supports core 0"
#else
#if 4>1 && ( defined _REGTC26X_H || defined _REGTC26XB_H )
#pragma message "This derivative only supports core 0 and 1."
#else
#if ( 4>2 ) && !( defined _REGTC38X_H || defined _REGTC39X_H || defined _REGTC39XB_H || defined _REGUSERDEF162_H )
#pragma message "This derivative only supports core 0, 1 and 2"
#else
#if ( 4>3 ) && !( defined _REGTC39X_H || defined _REGTC39XB_H || defined _REGUSERDEF162_H )
...
#if __USE_ARGC_ARGV_TC4
#pragma noclear                                 /* bss clearing not before cinit */
static char argcv_tc4[__ARGCV_BUFSIZE_TC4] __align(4);
#pragma clear
...
#if __C_TC4_INIT || _CALL_ENDINIT_TC4 || (defined __CALL_TC4_INIT)
/* c init semaphores */
...
static void inline reset_psw( void )
{
        ...
        value |= (__CDC_TC4 & 0x7f);    /* PSW.CDC call depth counter */
...
static void __noinline__ __noreturn__ __jump__ _start( void )
{
...
#ifdef __COMPAT_TC4
#if __COMPAT_TC4 != 0xf
        __mtcr(COMPAT, (~0x18|__COMPAT_TC4));
#endif
#endif
         ...
         */
#if __BIV_TC4_INIT
#if __BIV_SINGLE_TC4_INIT && (defined _REGUSERDEF16X_H || defined _REGUSERDEF162_H || defined _REGTC27X_H || defined _REGTC27XB_H || defined _REGTC27XC_H || defined _REGTC27XD_H || defined _REGTC26X_H  || defined _REGTC26XB_H || defined _REGTC29X_H)
        /*
...
#else
#if __BIV_8BYTE_TC4_INIT && (defined _REGUSERDEF16X_H || defined _REGUSERDEF162_H || defined _REGTC27X_H || defined _REGTC27XB_H || defined _REGTC27XC_H || defined _REGTC27XD_H || defined _REGTC26X_H || defined _REGTC26XB_H || defined _REGTC29X_H)
...
#  define MAX_NR_OF_CSA_AREAS     1
         ...
         */
#if __USE_ARGC_ARGV_TC4
        exit( main( _argcv( argcv_tc4, __ARGCV_BUFSIZE_TC4), (char **)argcv_tc4) );
#else
         ...
         */
#if __BTV_TC4_INIT
#  if __RESOLVE_TRAP_0_TC4
#    pragma extern  _trapmmu
#  endif
#  if __RESOLVE_TRAP_1_TC4
#    pragma extern  _trapprotection
#  endif
#  if __RESOLVE_TRAP_2_TC4
#    pragma extern  _trapinstruction
#  endif
#  if __RESOLVE_TRAP_3_TC4
#    pragma extern  _trapcontext
#  endif
#  if __RESOLVE_TRAP_4_TC4
#    pragma extern  _trapbus
#  endif
#  if __RESOLVE_TRAP_5_TC4
#    pragma extern  _trapassertion
#  endif
#  if __RESOLVE_TRAP_6_TC4
#    pragma extern  _trapsystem
#  endif
#  if __RESOLVE_TRAP_7_TC4
