...
#if (ICU_17_TIMERIP_DEV_ERROR_DETECT == STD_ON) || (ICU_17_TIMERIP_SAFETY_ENABLE == STD_ON)
/*
...
typedef struct
{
  ...
  /* Mapping between ERU OGU channel to logical channel identifier.
     16 bit value - lower 8bit(assuming there will be less than 256
     channels) for identifier.upper 8bit to identify which core is using that
     OGU.*/
  const uint16 EruChannelMap[ICU_17_TIMERIP_TOTAL_ERU_CHANNELS];
#endif
#if (ICU_17_TIMERIP_GPT12_USED == STD_ON)
  uint8 Gpt1TimerClockSel;
  uint8 Gpt2TimerClockSel;
#endif
...
**                  function.                                                 **
**               7. After initialization the mode is set to ICU_17_TIMERIP_MODE_NORMAL   **
**                                                                            **
** Service ID:      0                                                         **
**                                                                            **
...
#define Icu_17_TimerIp_InitCheck(ConfigPtr) \
        (ERROR_Icu_17_TimerIp_InitCheck_NOT_SELECTED)
#endif
...
/*MISRA2012_RULE_4_9_JUSTIFICATION:function like macro define used in preference
 *to function like macro where they are interchangeable*/
#define Icu_17_TimerIp_DeInit() (ERROR_Icu_17_TimerIp_DeInit_NOT_SELECTED)
#endif
...
**                 parameter.                                                 **
**               2.In ICU_17_TIMERIP_MODE_NORMAL mode all notifications are available as **
*                  configured and selected by the                             **
...
**               3.In ICU_17_TIMERIP_MODE_SLEEP mode only those notifications are        **
...
** Reentrancy:       non reentrant                                            **
**                                                                            **
** Parameters (in):  Mode : ICU_17_TIMERIP_MODE_NORMAL or ICU_17_TIMERIP_MODE_SLEEP                 **
**                                                                            **
** Parameters (out): none                                                     **
**                                                                            **
** Return value:     none                                                     **
...
#define Icu_17_TimerIp_SetMode(Mode) \
                              (ERROR_Icu_17_TimerIp_SetModeApi_NOT_SELECTED)
#endif
...
#define Icu_17_TimerIp_DisableWakeup(Channel) \
                    (ERROR_Icu_17_TimerIp_DisableWakeup_NOT_SELECTED)
#endif
...
#define Icu_17_TimerIp_EnableWakeup(Channel) \
                            (ERROR_Icu_17_TimerIp_EnableWakeup_NOT_SELECTED)
#endif
...
**                                                                            **
** Parameters (in):  Channel - Numeric identifier of the ICU channel          **
**                   Activation - ICU_17_TIMERIP_RISING_EDGE,ICU_17_TIMERIP_FALLING_EDGE,           **
**                                ICU_17_TIMERIP_BOTH_EDGES                              **
**                                                                            **
** Parameters (out): none                                                     **
**                                                                            **
...
#define Icu_17_TimerIp_DisableEdgeDetection(Channel)                           \
                        (ERROR_Icu_17_TimerIp_DisableEdgeDetection_NOT_SELECTED)
#endif
/*******************************************************************************
**                                                                            **
...
#define Icu_17_TimerIp_EnableEdgeDetection(Channel)                           \
                         (ERROR_Icu_17_TimerIp_EnableEdgeDetection_NOT_SELECTED)
#endif
/*******************************************************************************
...
/*MISRA2012_RULE_4_9_JUSTIFICATION:function like macro define used in preference
 *to function like macro where they are interchangeable*/
#define Icu_17_TimerIp_EnableMultiEdgeDetection(Channel)                     \
                        (ERROR_Icu_17_TimerIp_EnableEdgeDetection_NOT_SELECTED)
#endif
...
**               3. Once the service has returned the status ICU_17_TIMERIP_ACTIVE the   **
**                  stored status will be set to ICU_17_TIMERIP_IDLE until the next      **
**                  edge is detected.                                         **
...
#define Icu_17_TimerIp_GetInputState(Channel) \
                           (ERROR_Icu_17_TimerIp_GetInputState_NOT_SELECTED)
#endif
...
#define Icu_17_TimerIp_GetVersionInfo(versioninfo)      \
                                       (ERROR_IcuGetVersionInfoApi_NOT_SELECTED)
#endif
...
#define Icu_17_TimerIp_CheckWakeup(wakeupSource) \
                         (ERROR_Icu_17_TimerIp_CheckWakeup_NOT_SELECTED)
#endif
