...
#define GPT12_TxCON_RESET_VAL                   (0x0)
...
#define GPT12_T3CON_BPS1_LEN                    (0x2)
#define GPT12_T6CON_BPS2_LEN                    (0x2)
...
/* MISRA2012_RULE_5_5_JUSTIFICATION: External identifiers going beyond 32 chars.
  in generated code due to Autosar Naming constraints.*/
#define MCU_17_TIMERIP_START_SEC_VAR_INIT_ASIL_B_GLOBAL_UNSPECIFIED
/* MISRA2012_RULE_4_10_JUSTIFICATION: 'Mcu_MemMap.h' is header file which
 * contains the memory sections for Timer IP APIs. It should not be guarded by
 * standard include. No side effects foreseen by violating this MISRA rule. */
/* MISRA2012_RULE_20_1_JUSTIFICATION: 'Mcu_17_Ccu6_Kernel' and 'Mcu_17_Stm'
 * declared before MemMap header file. This variable needs to be placed in a
 * appropriate memory section. No side effects foreseen by violating
 * this MISRA rule */
#include "Mcu_MemMap.h"

static volatile Ifx_CCU6* const Mcu_17_Ccu6_Kernel[MCU_17_CCU6_NO_OF_KERNELS] =
{
  &MODULE_CCU60,
...
static volatile Ifx_STM* const Mcu_17_Stm[MCAL_NO_OF_CORES] =
{
  &MODULE_STM0,
...
/* MISRA2012_RULE_5_5_JUSTIFICATION: External identifiers going beyond 32 chars.
  in generated code due to Autosar Naming constraints.*/
#define MCU_17_TIMERIP_STOP_SEC_VAR_INIT_ASIL_B_GLOBAL_UNSPECIFIED
/* MISRA2012_RULE_4_10_JUSTIFICATION: 'Mcu_MemMap.h' is header file which
 * contains the memory sections for Timer IP APIs. It should not be guarded by
 * standard include. No side effects foreseen by violating this MISRA rule. */
/* MISRA2012_RULE_20_1_JUSTIFICATION: variable 'Mcu_17_Ccu6_Kernel' and
 * Mcu_17_Stm declared before MemMap header file. This variable needs to be
 * placed in a appropriate memory section. No side effects foreseen by violating
 * this MISRA rule */
#include "Mcu_MemMap.h"
 ...
 * contains the memory sections for Timer IP APIs. It should not be guarded by
 * standard include. No side effects foreseen by violating this MISRA rule. */
/* MISRA2012_RULE_20_1_JUSTIFICATION: variable 'Mcu_17_Gpt12_TimerCtrlReg'
 * declared before MemMap header file. This variable needs to be placed in a
 * appropriate memory section. No side effects foreseen by violating
 * this MISRA rule */
#include "Mcu_MemMap.h"
...
Mcu_17_Gpt12_TimerCtrlReg[MCU_17_GPT12_NO_OF_TIMERS] =
{
   ...
   * by violating this MISRA rule, since all the registers data types
     resolves to uint32*/
  (uint32*)&MODULE_GPT120.T2CON.U,
  /* MISRA2012_RULE_11_3_JUSTIFICATION: SFR access. No side effects foreseen
   * by violating this MISRA rule. */
  /* MISRA2012_RULE_11_8_JUSTIFICATION: SFR access.  No side effects foreseen
   * by violating this MISRA rule, since all the registers data types
     resolves to uint32*/
  (uint32*)&MODULE_GPT120.T3CON.U,
  /* MISRA2012_RULE_11_3_JUSTIFICATION: SFR access. No side effects foreseen
   * by violating this MISRA rule. */
  /* MISRA2012_RULE_11_8_JUSTIFICATION: SFR access.  No side effects foreseen
   * by violating this MISRA rule, since all the registers data types
     resolves to uint32*/
  (uint32*)&MODULE_GPT120.T4CON.U,
  /* MISRA2012_RULE_11_3_JUSTIFICATION: SFR access. No side effects foreseen
   * by violating this MISRA rule. */
  /* MISRA2012_RULE_11_8_JUSTIFICATION: SFR access.  No side effects foreseen
   * by violating this MISRA rule, since all the registers data types
     resolves to uint32*/
  (uint32*)&MODULE_GPT120.T5CON.U,
  /* MISRA2012_RULE_11_3_JUSTIFICATION: SFR access. No side effects foreseen
   * by violating this MISRA rule. */
  /* MISRA2012_RULE_11_8_JUSTIFICATION: SFR access.  No side effects foreseen
   * by violating this MISRA rule, since all the registers data types
     resolves to uint32*/
  (uint32*)&MODULE_GPT120.T6CON.U
  /* MISRA2012_RULE_11_3_JUSTIFICATION: SFR access. No side effects foreseen
   * by violating this MISRA rule. */
  /* MISRA2012_RULE_11_8_JUSTIFICATION: SFR access.  No side effects foreseen
   * by violating this MISRA rule, since all the registers data types
...
**                    time of channel抯 initialization.                       **
**                                                                            **
** Service ID       : 0x60                                                    **
**                                                                            **
...
)
{
   ...
   * [/cover] */
  /* [cover parentID={02EC2514-8DF2-4874-914C-9FFE5A5AE438}]
  * Enter Critical Section for TOM
  * [/cover] */
...
**                    慣imerOutputEn�, the application can decide to          **
...
)
{
  ...
  * [/cover] */
  ...
  /*[cover parentID={553B71FD-1F20-4c00-A17B-DF85C0F58E61}]*/
...
**                    the time of channel抯 initialization.                   **
**                                                                            **
** Service ID       : 0x64                                                    **
**                                                                            **
** Sync/Async       : Synchronous                                             **
...
)
{
   ...
   * [/cover] */
  /* [cover parentID={8B9E963E-AC41-4ad2-9769-0B55DD407CBB}]
  * Enter Critical Section for ATOM
  * [/cover] */
...
)
{
  ...
  /*[cover parentID={BA7E2479-9770-45ee-8A38-43289F9B6068}][/cover]*/
...
)
{
  ...
  /*[cover parentID={90B2870D-F637-412d-AB39-28A185D393A6}][/cover]*/
...
)
{
  ...
  {
    /* Clear the any interrupt status flags */
    /*[cover parentID={99593119-69F0-48b6-81F2-10F8DA0E3960}]*/
    Mcal_SetBitAtomic(&(Mcu_17_Ccu6_Kernel[Ccu6Kernel]->ISR.U), \
                      (Ccu6Comparator * CCU6_IEN_RCC6xRF_LEN), \
                      CCU6_IEN_RCC6xRF_LEN, \
                      CCU6_TIMER_RCC6xRF_INT_STAT_RST);
...
)
{
  ...
  Ccu60ClcSts = CCU60_CLC.B.DISS;
  Ccu61ClcSts = CCU61_CLC.B.DISS;

  /* [cover parentID={541D670E-99AB-43d3-9140-AB237931D8C9}]
   * Is CCU6 module enabled
   * [/cover] */
  if ((CCU6_KERNEL_ENABLE == Ccu60ClcSts) || \
      (CCU6_KERNEL_ENABLE == Ccu61ClcSts))
  {
...
)
{
   ...
   */
  *(Mcu_17_Gpt12_TimerCtrlReg[(ConfigPtr->TimerId)]) = ConfigPtr->TimerCtrlReg;
...
/*******************************************************************************
** Traceability     : [cover parentID={904BE317-98A3-48cd-883D-58124F7603BD}] **
**                                                                            **
...
** Return value     : None                                                    **
*******************************************************************************/
void Mcu_17_Gpt12_TimerClockInit
(
  const Mcu_17_Gpt12_TimerBlockType BlockId,
  const Mcu_17_Gpt12_ClkPrescalarType ClockDiv
)
{
  if(MCU_GPT12_GPT1_BLOCK == BlockId)
  {
    /* Configure the clock divider for Block 1 in T3 control register */
    Mcal_SetBitAtomic(&(MODULE_GPT120.T3CON.U), \
                      IFX_GPT12_T3CON_BPS1_OFF, \
                      GPT12_T3CON_BPS1_LEN, \
                      ClockDiv);
  }
  else
  {
    /* Configure the clock divider for Block 2 in T6 control register */
    Mcal_SetBitAtomic(&(MODULE_GPT120.T6CON.U), \
                      IFX_GPT12_T6CON_BPS2_OFF, \
                      GPT12_T6CON_BPS2_LEN, \
                      ClockDiv);
  }
  /* MISRA2012_RULE_2_7_JUSTIFICATION: ClockDiv is used in Mcal_SetBitAtomic
   * No side effects foreseen by violating this MISRA rule. */
  /*[cover parentID={C8410B61-0BFF-49d6-9BBD-817EA33BF71D}]Interrupt Control
  Registers[/cover]*/
}
...
**                    specified by 慖ndex� in the data 慥alue�. Hence the     **
...
** Parameters (out) : None                                                    **
**                                                                            **
** Return value     : 0 � Data in Bit position(慖ndex�) is 0                  **
**                    1 � Data in Bit position(慖ndex�) is 1                  **
**                                                                            **
*******************************************************************************/
...
)
{
  ...
  if(IcmStatus != GTM_BIT_CLEAR)
  {
    ...
    do
    {
       ...
       * [/cover] */
      /* [cover parentID={67842DB0-3B69-4fd6-98AB-A461170FD3BE}]
       * Get interrupt source
       * [/cover] */
...
)
{
  ...
  if(IcmStatus != GTM_BIT_CLEAR)
  {
    ...
    /* Loop through both the channels */
    /* [cover parentID={2C7D422E-C0E9-466f-BEB8-D63128BFB0F4}]
     * Is Channel Index greater than zero*/
    do
    {
      ChanIndex--;
      ...
      (UserId <= (uint8)TIMER_NO_OF_CALLBACK))
  {
        ...
        NULL_PTR)
    {
      ...
      /* [cover parentID={423561A7-11F3-4928-9790-2E4E01A52DBA}]
         * Invoke callback notification for identified User Id
         * [/cover] */
      /*[cover parentID={611BAAB8-DF35-4160-B033-D43924E1E9BF}][/cover]*/
...
)
{
                                    ...
                                    (UserId2 != (uint8)TIMER_IP_NO_USER))
  {
    ...
    if (IrqStatus > 0x0U)
    {
      ...
      /*[cover parentID={34397A1A-EBEE-4fdd-A8B0-A0A3E017B894}][/cover]*/
      ...
      do
      {
        ...
        /* [cover parentID={A598A9A5-91F6-4848-ADE1-5058B63BC566}]
        ...
        if (0U != Mcal_GetBitAtomic(*EruIgpPtr, EruIgpPos, ERU_IGP_LEN))
        {
          ...
          /*[cover parentID={D7B3ED53-78CD-4695-B366-2BD2489397CA}][/cover]*/
          MODULE_SCU.FMR.U = (((uint32)ERU_BIT_SET << \
                               (EruChInputUnit + ERU_FCSTART)));

          /* Does the valid User ID have a callback function */
          /* [cover parentID={CB280374-5887-43e9-A01D-DC06A412A4AA}]
           * User Id has a callback function or not
           * [/cover] */
              ...
              [(UserId - (uint8)ERU_BIT_SET)] != NULL_PTR)
          {
            ...
            /*[cover parentID={611BAAB8-DF35-4160-B033-D43924E1E9BF}]
            [/cover]*/
