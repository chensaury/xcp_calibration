...
#include "McalLib.h"
/*
MISRA2012_RULE_20_5_JUSTIFICATION:
...
#define GPT_E_INVALID_ISR            ((uint8)0xC8U)
...
/* Channel Status indicators*/
#define GPT_GTM_INVALID_NUMBER       ((uint8)0xFFU)
...
typedef struct
{
  ...
  Mcu_17_Gtm_TomAtomChConfigType GptGtmTimerInfo;
