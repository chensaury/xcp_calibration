...
#if ( DMA_SW_MAJOR_VERSION != 2U )
  #error "DMA_SW_MAJOR_VERSION does not match."
#endif
#if ( DMA_SW_MINOR_VERSION != 1U )
...
/* Macro for updating the IRQ registers */
/* MISRA2012_RULE_4_9_JUSTIFICATION: Function like macro
 * 'DMA_IRQSFR_MODIFY32'defined for updating IRQ registers.
 * No side effects foreseen by violating this MISRA rule. */
#define DMA_IRQSFR_MODIFY32(reg, clearmask ,setmask) \
...
#define DMA_GET_CH_INITSTATE(Channel, lCoreId) \
  ...
  ((uint8)((Dma_kConfigPtr->Dma_ChannelMaps[Channel].\
                            Dma_ChannelConfIndexMap)%(uint8)8))) & DMA_ONE)

/******************************************************************************/

/* Macros for the fixed values */
#define DMA_ZERO            (0x00U)
#define DMA_ONE             (0x01U)
...
#define DMA_CHCSR_CLEAR_VALUE       ((uint32)0x06000000)
...
#define DMA_ERROR_STATUS_MASK   \
               (( (uint32)DMA_ONE << IFX_DMA_ME_ERRSR_DLLER_OFF ) |\
                ( (uint32)DMA_ONE << IFX_DMA_ME_ERRSR_SLLER_OFF ) |\
                ( (uint32)DMA_ONE << IFX_DMA_ME_ERRSR_RAMER_OFF ) |\
                ( (uint32)DMA_ONE << IFX_DMA_ME_ERRSR_SRIER_OFF ) |\
                ( (uint32)DMA_ONE << IFX_DMA_ME_ERRSR_SPBER_OFF ) |\
                ( (uint32)DMA_ONE << IFX_DMA_ME_ERRSR_DER_OFF   ) |\
                ( (uint32)DMA_ONE << IFX_DMA_ME_ERRSR_SER_OFF   ) )
...
#define DMA_GPSR_CLEAR_MASK              (0xFFFFFFFFU)
...
)
{
    ...
    #endif
    {
        ...
        if( MCAL_MASTER_COREID == lCoreId )
        {
            ...
            if(MODULE_DMA.CLC.B.DISS == DMA_ZERO)
            {
...
)
{
    ...
    {   /* Is the requested channel outside the valid range of channels
        ...
        [/cover] */
        /* [cover parentID={7BE7CD26-3CB6-4c94-9ADC-32978F39D816}]
        Does the channel configuration exist in the configuration?
        [/cover] */
    ...
    {
        /* [cover parentID={4FED8649-091E-48d9-947E-9E0B13D39240}]
        Det is On
        [/cover] */
        /* [cover parentID={04F16480-A7D5-4ede-9C04-8091C2E24D68}]
    ...
    #endif
    {
        ...
        [/cover] */
        /* [cover pparentID= {4FC90E5B-4606-4e81-9AD8-B53D071B7AEF}]
        Exclusive area
        [/cover] */
...
)
{
    ...
    DET checks
    [/cover] */
    /* [cover pparentID={66713F4F-E64C-4cdf-8C31-9366DD8CD3AF}]
    DET enabled
    [/cover] */
    ...
    if(Config == NULL_PTR)
    {
        /* [cover pparentID={9B45BD3F-AA44-4878-B410-7737D01C034E}]
        Report DET for NULL pointer
        [/cover] */
    ...
    {
        /* [cover pparentID={8D6D37A5-6B48-4c2d-8EA8-53D5119F72DD}]
        Report DET for 'Not Initialized' state
        [/cover] */
    ...
    {
        /* [cover pparentID={C297E897-A49A-41a4-BC97-89B31082C37C}]
        Report DET for 'Invalid Channel ID'
        [/cover] */
    ...
    {   /* Is the requested channel not assigned to this core? */
        ...
        /* [cover pparentID={EE98434D-22BC-4855-8D93-344EFCE3BF50}]
        Report DET for 'Core-Channel Mismatch'
        [/cover] */
...
)
{
    ...
    #endif
    {
        ...
        'SchM_Enter_Dma_ChannelConfigUpdate'
        [/cover] */
        /* [cover pparentID= {9AFDB4FE-6895-41a4-9473-AB570274AFF4}]
        Exclusive area
        [/cover] */
        ...
        if(MODULE_DMA.CH[Channel].CHCSR.B.TCOUNT != 0x00U)
        {
            ...
            if(MODULE_DMA.TSR[Channel].B.HLTACK == (uint32)DMA_ZERO)
            {
                ...
                while((MODULE_DMA.TSR[Channel].B.HLTACK==(uint32)DMA_ZERO)
                        &&
                ...
                if(MODULE_DMA.TSR[Channel].B.HLTACK == DMA_ZERO)
                {
...
)
{
    ...
    #endif
    {
        ...
        'SchM_Enter_Dma_ChannelConfigUpdate'
        [/cover] */
        /* [cover pparentID= {BEF2A3E5-725A-42d2-AEE2-CE5F3817D9E2}]
        Exclusive area
        [/cover] */
...
{
    #if( (DMA_DEV_ERROR_DETECT == STD_ON) || (DMA_SAFETY_ENABLE == STD_ON) )
    /* [cover pparentID={A4E67F06-1B76-4cac-B5C1-E250329C7BDD}]
    DET is on
    [/cover] */
    ...
    /* [cover pparentID={9E869EF4-0E8E-4b6d-9BF9-D3D159177500}]
    Check for any DET errors
    [/cover] */
    ...
    #endif
    {
        /* Lock entry for core */
        SchM_Enter_Dma_ChannelConfigUpdate();
        /* [cover pparentID={08C6988B-F434-4a52-A3BB-5466ABBB23DE}]
        Critical section - StartStop
        [/cover] */
        /* [cover pparentID={7D4E210C-69B9-4bad-904D-1E34A015D656}]
        Enter the critical section, by calling
        'SchM_Enter_Dma_ChannelConfigUpdate'
        [/cover] */
        /* [cover pparentID= {55BFF820-5ACF-48fc-8236-F59C0F229EF2}]
        Exclusive area
        [/cover] */
        ...
        {
            /* [cover pparentID={E4F092E3-3BC4-4a3d-AB1F-62301E297447}]
            DET is on
            [/cover] */
            /* [cover pparentID={857F20C4-2753-416f-AACC-8BDA81820E69}]
            Report Det for 'Transfer in Progress'
            [/cover] */
        ...
        /* Lock exit for core */
        SchM_Exit_Dma_ChannelConfigUpdate();
        /* [cover pparentID={ED8C1B5E-E4AF-4ed9-A29A-56939B15DD10}]
        Leave the critical section, by calling
        'SchM_Exit_Dma_ChannelConfigUpdate'
        [/cover] */
...
)
{
    ...
    /* [cover pparentID={79144AB0-41EF-4320-ABBF-36C00ED2F0EF}]
    DET is ON
    [/cover] */
    /* [cover pparentID={1A733837-FE5F-4a5d-985A-F1EC3E4A2C42}]
    Check for any DET errors
    [/cover] */
    ...
    #endif
    {
        /* Lock entry for core */
        SchM_Enter_Dma_ChannelConfigUpdate();
        /* [cover pparentID={5F48B999-B78A-4f44-95C6-8F3EE7FA5138}]
        Enter the critical section, by calling
        'SchM_Enter_Dma_ChannelConfigUpdate'
        [/cover] */
        /* [cover pparentID= {55BFF820-5ACF-48fc-8236-F59C0F229EF2}]
        ...
        while( (MODULE_DMA.TSR[Channel].B.RST != DMA_ZERO)
                &&
               (lLoopCount < (uint32)DMA_TIMEOUT) )
        {
            lLoopCount++;
        ...
        if(MODULE_DMA.TSR[Channel].B.RST != DMA_ZERO)
        {
            /* [cover parentID={9F1E5655-8FE7-447f-92D7-A2568F8F52FF}]
            Did timeout occour, without channel reset?
            [/cover] */
            /* [cover pparentID={397146FD-FDED-4019-8519-F5E7025AC9E4}]
            Report DET for 'Timeout'
            [/cover] */
            /* [cover pparentID={929D5E53-333F-4cad-B8E6-28060A299C3E}]
            DET is ON
            [/cover] */
        ...
        /* Lock exit for core */
        SchM_Exit_Dma_ChannelConfigUpdate();
        /* [cover pparentID={EEF341BF-134E-453a-B77D-1D9E9ACAF286}]
        Leave the critical section, by calling
        'SchM_Exit_Dma_ChannelConfigUpdate'
        [/cover] */
    }
...
)
{
    ...
    #endif
    {
        ...
        else
        {
            ...
            Report Det for 'Invalid switch request'
            [/cover] */
...
/*******************************************************************************
** Traceability: [cover parentID={BB3DD9C7-3C87-499f-962C-7690C470C340}]      **
**                                                                            **
** Syntax : Std_ReturnType Dma_ChIsStatusAsserted (uint8 Channel,             **
...
**                                                                            **
*******************************************************************************/
Std_ReturnType Dma_ChIsStatusAsserted
(
    const uint8 Channel,
...
)
{
    ...
    uint8 lStatus = FALSE;
    /* [cover parentID={EF2C9095-9983-4ed2-BC0B-B0FED5592C66}]
    Give status as 'Event not present'
    [/cover] */

    #if( (DMA_DEV_ERROR_DETECT == STD_ON) || (DMA_SAFETY_ENABLE == STD_ON) )
    uint32 lDetStatus;

    /* [cover parentID={573359B2-B748-4cd9-9AEA-AE81380D22AD}]
    DET or Safety Enabled
    [/cover] */
    /* [cover parentID={ACB14ED8-B780-43c6-9AE1-F8BD27857201}]
    Check for any DET or safety errors
    [/cover] */

    lDetStatus = Dma_lDetCheck(DMA_SID_CHISSTATUSASSERTED,Channel);

    /* [cover parentID={6EF66FBF-405B-443b-8F0D-FD509B749EB4}]
    Any errors present?
    [/cover] */
    if(lDetStatus == (uint32)FALSE)
    #endif
    {
        ...
        if(MODULE_DMA.TSR[Channel].B.CH == 0x00U)
        {
            ...
            {
                /* [cover parentID={89D588C6-BDD4-40ca-A96C-7E17CA75C879}]
                Is the request for
                'Transfer Complete' event?
                [/cover] */

                /* Channel Interrupt has been raised */
                lStatus = MODULE_DMA.CH[Channel].CHCSR.B.ICH;
            }
            else if (Event == DMA_CHEVENT_BUFFER_WRAP_SOURCE)
            {
                /* [cover parentID={DAEEA761-D9F2-4984-9577-76D8AA3544CA}]
                Is the request for
                'Wrap Source' event?
                [/cover] */

                lStatus = MODULE_DMA.CH[Channel].CHCSR.B.WRPS;
            }
            else if (Event == DMA_CHEVENT_BUFFER_WRAP_DEST)
            {
                /* [cover parentID={427F72C2-E514-445e-A855-9F0656451DE0}]
                Is the request for
                'Wrap Destination' event?
                [/cover] */

                lStatus = MODULE_DMA.CH[Channel].CHCSR.B.WRPD;
            }
            else
            {
                lStatus = FALSE;
                #if( (DMA_DEV_ERROR_DETECT == STD_ON) || \
                     (DMA_SAFETY_ENABLE    == STD_ON) )
                /* [cover parentID={DE679AD3-6F05-41e8-82CA-C5561B48BFED}]
                Report DET or safety error for invalid event
                [/cover] */
                /* [cover parentID={9BD3559A-79AC-41f4-AFF0-CDE926E63A01}]
                DET or Safety Enabled
                [/cover] */

                /*Report DET for Invalid event*/
                Dma_lReportError( DMA_SID_CHISSTATUSASSERTED, \
        ...
        {
            /* [cover parentID={F1CFD85D-B4E8-4449-A8EB-27F239ECCE5F}]
            DET or Safety Enabled
            [/cover] */
    ...
    if(lStatus != FALSE)
    {
        /* [cover parentID={681AF4C4-36AC-4ca1-A463-CBE68C148D5B}]
        Give status as 'Event present'
        [/cover] */
        lRetVal = E_OK;
    }
...
)
{
    ...
    #endif
    {
        /* [cover pparentID= {B3F8B1D6-FA91-4e3b-BE23-8BE5CA90B4B6}]
        Exclusive area
        [/cover] */
        ...
        if(MODULE_DMA.TSR[Channel].B.CH == 0x00U)
        {
            if(Event == DMA_CHEVENT_TRANSFER_COMPLETE)
            {
                ...
                DMA_RUNTIME_SETBITATOMIC( \
                    ...
                    (Event == DMA_CHEVENT_BUFFER_WRAP_DEST))
            {
...
)
{
    ...
    #endif
    {
        /* [cover pparentID= {FCBE728A-8968-4fce-A6EA-A80A9A9EC93D}]
        Exclusive area
        [/cover] */
        ...
        {
            if(lTsrReg.B.HLTACK == (uint32)DMA_ONE)
            {
            ...
            if(lTsrReg.B.CH == (uint32)DMA_ONE)
            {
                /* Report DET */
                Dma_lReportError( DMA_SID_CHINTERRUPTENABLE, \
                                  DMA_E_DATA_TRANSFER_IN_PROGRESS );
...
/*******************************************************************************
** Traceability: [cover parentID={413AF603-801D-40aa-B445-8AF8FE7A6E8B}]      **
**                                                                            **
** Syntax : uint32 Dma_GetChannelEvent ( uint8 Channel)                       **
**                                                                            **
...
)
{
    ...
    /* [cover parentID={FF0510D5-EB38-481a-8DED-6A7E2D397665}]
    DET or Safety Enabled
    [/cover] */
    /* [cover parentID={027859BF-C6EA-412e-92C9-FB9669BA0B1A}]
    Check for any DET or safety errors
    [/cover] */

    lDetStatus = Dma_lDetCheck(DMA_SID_GETCHEVENT, Channel);
    ...
    #endif
    {
        ...
        if(MODULE_DMA.TSR[Channel].B.CH == 0x00U)
        {
            ...
            if(lChcsrReg.B.ICH == DMA_ONE)
            {
                lRetVal = (uint32)DMA_CHEVENT_TRANSFER_COMPLETE;
            }

            if(lChcsrReg.B.WRPD == DMA_ONE)
            {
                lRetVal |= (uint32)DMA_CHEVENT_BUFFER_WRAP_DEST;
            }

            if(lChcsrReg.B.WRPS == DMA_ONE)
            {
                lRetVal |= (uint32)DMA_CHEVENT_BUFFER_WRAP_SOURCE;
            }
        }
        #if( (DMA_DEV_ERROR_DETECT == STD_ON) || \
             (DMA_SAFETY_ENABLE    == STD_ON) )
        ...
        {
            /* Report DET */
            Dma_lReportError( DMA_SID_GETCHEVENT, \
                              DMA_E_DATA_TRANSFER_IN_PROGRESS );
...
/*******************************************************************************
** Traceability: [cover parentID={DAF196AF-B6F0-4106-B854-55C2937DED4A}]      **
**                                                                            **
** Syntax : uint32 Dma_GetMoveEngineEvent ( uint8 Channel)                    **
**                                                                            **
...
)
{
    ...
    /* [cover parentID={C0B7550C-A5A0-4605-891E-1BA613D14133}]
    Error Checks
    [/cover] */

    lDetStatus = Dma_lDetCheck(DMA_SID_GETMEEVENT, Channel);
    /* [cover parentID={89F2C2F1-C4FC-44fe-BB38-47196FBEC708}]
    Check for any DET or safety errors
    [/cover] */
    /* [cover parentID={8BB8BF05-7362-4c37-B778-6E038F3CFE1A}]
    Any errors present?
    [/cover] */
    if(lDetStatus == (uint32)FALSE)
    #endif
    {
        ...
        'SchM_Enter_Dma_ChannelConfigUpdate'
        [/cover] */
        /* [cover pparentID={D6295A7F-6B58-44a5-AE2C-31A07CB11C5F}]
        Enter the critical section, by calling
        'SchM_Enter_Dma_ChannelConfigUpdate'
        [/cover] */
        ...
        if(MODULE_DMA.TSR[Channel].B.CH == 0x00U)
        {
            ...
            lMeErrReg = DMA_ME0_ERRSR;

            /* Check if any event is available on ME 0 */
            if((lMeErrReg.U & DMA_ERROR_STATUS_MASK) != 0x00U)
            {
            ...
            if(MODULE_DMA.TSR[Channel].B.TRL == DMA_ONE)
            {
                ...
                lRetVal |= (uint32)DMA_CHANNEL_TRL_ERROR;
            }
        }
        #if( (DMA_DEV_ERROR_DETECT == STD_ON) || \
             (DMA_SAFETY_ENABLE    == STD_ON) )
        ...
        {
            /* [cover parentID={9B6A3D0E-6AE9-477f-8E98-8442C32C212F}]
            DET or Safety Enabled
            [/cover] */
            ...
            /* Report DET */
            Dma_lReportError( DMA_SID_GETMEEVENT, \
                              DMA_E_DATA_TRANSFER_IN_PROGRESS );
        ...
        'SchM_Exit_Dma_ChannelConfigUpdate'
        [/cover] */
        /* [cover pparentID={FE0043BD-D152-4a28-AAF0-5458D31FBA00}]
        Exit the critical section, by calling
        'SchM_Exit_Dma_ChannelConfigUpdate'
        [/cover] */
        SchM_Exit_Dma_ChannelConfigUpdate();
...
)
{
    ...
    [/cover] */
    if( (MoveEngineNumber == DMA_ME_NONE) ||\
...
{
    Dma_ChannelNotificationPtrType lChNotify = NULL_PTR;
    /* MISRA2012_RULE_19_2_JUSTIFICATION: Union based type definition for SFR
       access. Variable of SFR type defined for writing into register.
       No side effects foreseen by violating this MISRA rule.*/
    Ifx_DMA_CH_CHCSR lChcsrReg;
    uint32 lEvent   = (uint32)DMA_CHEVENT_NONE;
    uint32 lCoreId  = 0;     /* ID of core used for execution */
    uint8  lChIndex = 0U;
        ...
        (Channel < (uint8)DMA_MAX_NUM_OF_CHANNELS) )
    {
           ...
           (Dma_kConfigPtr->DmaCoreConfigPtr[lCoreId] != NULL_PTR) )
        {
            ...
            if(lChIndex != DMA_CHANNEL_MAP_RESET_VALUE)
            {
                ...
                lChNotify = Dma_kConfigPtr->DmaCoreConfigPtr[lCoreId]->\
                ...
                if(lChNotify != NULL_PTR)
                {
                   ...
                   /*[cover parentID={332E21C2-03C8-465c-861C-E533C4D03301}]
                        ...
                        /* Clear interrupt for DMA channel */
                        MODULE_DMA.CH[Channel].CHCSR.B.CICH = DMA_ONE;
                        lEvent |= (uint32)DMA_CHEVENT_TRANSFER_COMPLETE;
                    }
                  ...
                  /* [cover parentID={0C9157AD-A241-4855-BB03-6A088E62520F}]
                        ...
                        MODULE_DMA.CH[Channel].CHCSR.B.CWRP = DMA_ONE;
                        lEvent |= (uint32)DMA_CHEVENT_BUFFER_WRAP_DEST;
                    }
                    if(lChcsrReg.B.WRPS == DMA_ONE)
                    {
                  ...
                  /* [cover parentID={98EE47B1-A53A-4dcc-BE5F-B41042A42416}]
                        ...
                        /* Clear wrap buffer status bit */
                        MODULE_DMA.CH[Channel].CHCSR.B.CWRP = DMA_ONE;
                        lEvent |= (uint32)DMA_CHEVENT_BUFFER_WRAP_SOURCE;
                    }
                    if(lEvent == (uint32)DMA_CHEVENT_NONE)
                    {
                   /*[cover parentID={841622AC-B7F8-4fc1-9B0F-BEDC661C78A1}]
                         ...
                         * be an unknown event. */
                        lEvent = (uint32)DMA_CHEVENT_UNKNOWN_EVENT;
                    }
...
)
{
    ...
    if((ME0_ErrorStatus.U & DMA_ERROR_STATUS_MASK) != 0x00U)
    {
        ...
        Dma_MEInterruptHandler(DMA_MOVE_ENGINE_0, ME0_ErrorStatus.U);
    }
    ...
    if((ME1_ErrorStatus.U & DMA_ERROR_STATUS_MASK) != 0x00U)
    {
        ...
        Dma_MEInterruptHandler(DMA_MOVE_ENGINE_1, ME1_ErrorStatus.U);
    }

    /* Check for the TRL status */
    while( (lChannelIndex < DMA_MAX_NUM_OF_CHANNELS) && \
           (lChannelFound == (uint8)0) )
    {
        ...
        [/cover] */
        if(MODULE_DMA.TSR[lChannelIndex].B.ETRL == DMA_ONE)
        {
            if(MODULE_DMA.TSR[lChannelIndex].B.TRL  == DMA_ONE)
            {
                ...
                lChannelFound = 1;
                Dma_MEInterruptHandler(lChannelIndex, 0);
            }
        }
        lChannelIndex++;
    }
...
/*******************************************************************************
** Traceability: [cover parentID={70E3D68B-8363-4046-A3D0-9A09A19C9B6A}]      **
**                                                                            **
** Syntax : void Dma_MEInterruptHandler (const uint8 MoveEngine,              **
...
)
{
    ...
    Ifx_DMA_ME_ERRSR lMeErrReg;
    uint8 lChannelId;
    uint32 lMeErrEvent = (uint32)DMA_MOVE_ENGINE_EVENT_NONE;
    Dma_MoveEngineErrorNotificationPtrType lMeNotify;
    ...
    if( Dma_kConfigPtr != NULL_PTR )
    {
        /* [cover parentID={D9298605-C337-4b42-A8B0-4D357FDBBA3E}]
        Is the config pointer null?
        [/cover] */
        ...
        if(lCurrentCoreId != lChannelCoreOwnerId)
        {
            ...
            /* Update the TOS for the particular interrupt */
            DMA_IRQSFR_MODIFY32(SRC_GPSR_GPSR0_SR0.U, DMA_GPSR_CLEAR_MASK, \
                    (Dma_CoreTosMap[lChannelCoreOwnerId]));

            /* Service request enable - To enable a service request
             * this has to be enabled. */
            SRC_GPSR_GPSR0_SR0.B.SRE = 1;

            /* [cover parentID={BE05E662-D33E-44fb-A8A3-354142F491C9}]
            Trigger the GPSR
            [/cover] */

            /* Trigger the GPSR - set the corresponding SETR bit */
            SRC_GPSR_GPSR0_SR0.B.SETR = 1;
        }
        else
        {
                ...
                if(lChIndex != DMA_CHANNEL_MAP_RESET_VALUE)
                {
                    ...
                    if(lMeNotify != NULL_PTR)
                    {
                      ...
                      /* [cover parentID={DE94A406-8B65-4584-BE90-832D14273175}]
                            ...
                            /* Clear the ME errors */
                            lMeClrReg->B.CSER   = DMA_ONE;
                            lMeClrReg->B.CDER   = DMA_ONE;
                            lMeClrReg->B.CRAMER = DMA_ONE;
                            lMeClrReg->B.CSLLER = DMA_ONE;
                            lMeClrReg->B.CDLLER = DMA_ONE;
                            lMeClrReg->B.CSPBER = DMA_ONE;
                            lMeClrReg->B.CSRIER = DMA_ONE;
                        }
                        else
                        {
                            if(MODULE_DMA.TSR[lChannelId].B.TRL == DMA_ONE)
                            {
                      ...
                      /* [cover parentID={5E421D60-DF77-43f3-8217-97CDDE591204}]
                                ...
                                MODULE_DMA.TSR[lChannelId].B.CTL = DMA_ONE;
                                lMeErrEvent |= (uint32)DMA_CHANNEL_TRL_ERROR;
                            }
                        }

                      /* [cover parentID={BF1FF99C-E32B-41ff-A6DC-962827884329}]
                        Are there any valid error reasons found?
                        [/cover] */
...
)
{
       ...
       (lAdicr.B.SHCT != DMA_SHADOW_ADDR_RES3_MASK))
    {
        ...
        [/cover] */
        /* [cover pparentID={B8DF546C-62CA-467a-A82A-A9E8D1B36B05}]
        Assign the shadow address register with the shadow address
        [/cover] */
...
)
{
    ...
    if(Config->UpdateDataCrc == (uint8)DMA_ONE)
    {
    ...
    if(Config->UpdateAddressCrc == (uint8)DMA_ONE)
    {
    ...
    if(Config->UpdateSourceAddress == (uint8)DMA_ONE)
    {
    ...
    if(Config->UpdateDestAddress == (uint8)DMA_ONE)
    {
    ...
    if(Config->UpdateControlAdicr == (uint8)DMA_ONE)
    {
    ...
    if(Config->UpdateControlChcsr == (uint8)DMA_ONE)
    {
    ...
    if(Config->UpdateConfig == (uint8)DMA_ONE)
    {
    ...
    if(Config->UpdateShadowConfig == (uint8)DMA_ONE)
    {
        ...
        else
        {
            ...
            DET or safety check enabled
            [/cover] */
            /* [cover pparentID={7983E969-55B3-4d63-B69B-BCA2CEA8891A}]
            Report DET for Shadow configuration request
            [/cover] */
            /* [cover pparentID={BD72E278-C355-46ec-91A9-04511ADEDB12}]
            DET enabled
            [/cover] */
...
)
{
    ...
    if(lMeErrReg.B.SER == DMA_ONE)
    {
        ...
        [/cover] */
        lRetVal = (uint32)DMA_MOVE_ENGINE_SOURCE_ERROR;
    }

    if(lMeErrReg.B.DER == DMA_ONE)
    {
        ...
        [/cover] */
        lRetVal |= (uint32)DMA_MOVE_ENGINE_DESTINATION_ERROR;
    }

    if(lMeErrReg.B.RAMER == DMA_ONE)
    {
        ...
        Is it a 'RAM error'?
        [/cover] */
        lRetVal |= (uint32)DMA_MOVE_ENGINE_RAM_ERROR;
    }

    if(lMeErrReg.B.SLLER == DMA_ONE)
    {
        ...
        [/cover] */
        lRetVal |= (uint32)DMA_MOVE_ENGINE_SAFE_LINKEDLIST_ERROR;
    }

    if(lMeErrReg.B.DLLER == DMA_ONE)
    {
        ...
        [/cover] */
        lRetVal |= (uint32)DMA_MOVE_ENGINE_DMA_LINKEDLIST_ERROR;
    }

    if(lMeErrReg.B.SPBER == DMA_ONE)
    {
        ...
        Is it an SPB error?
        [/cover] */
        lRetVal |= (uint32)DMA_MOVE_ENGINE_SPB_ERROR;
    }

    if(lMeErrReg.B.SRIER == DMA_ONE)
    {
        ...
        Is it an SRI error?
        [/cover] */
        lRetVal |= (uint32)DMA_MOVE_ENGINE_SRI_ERROR;
    }
