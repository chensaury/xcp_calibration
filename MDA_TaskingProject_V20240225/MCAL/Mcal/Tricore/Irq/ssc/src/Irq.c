...
{
  /* Set CLRR to clear SRR bit and disable SRE bit */
  #if (IRQ_ETH0_EXIST == STD_ON)
  SRC_GETH0.U = IRQ_DISABLE_CLEAR_SRC;
  #endif/*End of IRQ_ETH0_EXIST*/
  #if (IRQ_ETH1_EXIST == STD_ON)
  SRC_GETH1.U = IRQ_DISABLE_CLEAR_SRC;
  #endif/*End of IRQ_ETH1_EXIST*/
  #if (IRQ_ETH2_EXIST == STD_ON)
  SRC_GETH2.U = IRQ_DISABLE_CLEAR_SRC;
  #endif/*End of IRQ_ETH2_EXIST*/
  #if (IRQ_ETH3_EXIST == STD_ON)
  SRC_GETH3.U = IRQ_DISABLE_CLEAR_SRC;
  #endif/*End of IRQ_ETH3_EXIST*/
  #if (IRQ_ETH4_EXIST == STD_ON)
  SRC_GETH4.U = IRQ_DISABLE_CLEAR_SRC;
  #endif/*End of IRQ_ETH4_EXIST*/
  #if (IRQ_ETH5_EXIST == STD_ON)
  SRC_GETH5.U = IRQ_DISABLE_CLEAR_SRC;
  #endif/*End of IRQ_ETH5_EXIST*/
  #if (IRQ_ETH6_EXIST == STD_ON)
  SRC_GETH6.U = IRQ_DISABLE_CLEAR_SRC;
  #endif/*End of IRQ_ETH6_EXIST*/
  #if (IRQ_ETH7_EXIST == STD_ON)
  SRC_GETH7.U = IRQ_DISABLE_CLEAR_SRC;
  #endif/*End of IRQ_ETH7_EXIST*/
  #if (IRQ_ETH8_EXIST == STD_ON)
  SRC_GETH8.U = IRQ_DISABLE_CLEAR_SRC;
  #endif/*End of IRQ_ETH8_EXIST*/
  #if (IRQ_ETH9_EXIST == STD_ON)
  SRC_GETH9.U = IRQ_DISABLE_CLEAR_SRC;
  #endif/*End of IRQ_ETH9_EXIST*/
}
#endif/*End of IRQ_ETH_EXIST*/
...
void IrqEthernet_Init(void)
{
  ...
  IRQ_SFR_MODIFY32 (SRC_GETH0.U , IRQ_CLEAR_MASK , \
                     ((uint32)IRQ_ETH_SR0_TOS |(uint32) IRQ_ETH_SR0_PRIO));
  #endif/*End of IRQ_ETH0_EXIST*/
  #if (IRQ_ETH1_EXIST == STD_ON)
  IRQ_SFR_MODIFY32 (SRC_GETH1.U , IRQ_CLEAR_MASK , \
                     ((uint32)IRQ_ETH_SR1_TOS |(uint32) IRQ_ETH_SR1_PRIO));
  #endif/*End of IRQ_ETH1_EXIST*/
  #if (IRQ_ETH2_EXIST == STD_ON)
  IRQ_SFR_MODIFY32 (SRC_GETH2.U , IRQ_CLEAR_MASK , \
                     ((uint32)IRQ_ETH_SR2_TOS |(uint32) IRQ_ETH_SR2_PRIO));
  #endif/*End of IRQ_ETH2_EXIST*/                     
  #if (IRQ_ETH3_EXIST == STD_ON)
  IRQ_SFR_MODIFY32 (SRC_GETH3.U , IRQ_CLEAR_MASK , \
                     ((uint32)IRQ_ETH_SR3_TOS |(uint32) IRQ_ETH_SR3_PRIO));
  #endif/*End of IRQ_ETH3_EXIST*/
  #if (IRQ_ETH4_EXIST == STD_ON)
  IRQ_SFR_MODIFY32 (SRC_GETH4.U , IRQ_CLEAR_MASK , \
                     ((uint32)IRQ_ETH_SR4_TOS |(uint32) IRQ_ETH_SR4_PRIO));
  #endif/*End of IRQ_ETH4_EXIST*/
  #if (IRQ_ETH5_EXIST == STD_ON)
  IRQ_SFR_MODIFY32 (SRC_GETH5.U , IRQ_CLEAR_MASK , \
                     ((uint32)IRQ_ETH_SR5_TOS |(uint32) IRQ_ETH_SR5_PRIO));
  #endif/*End of IRQ_ETH5_EXIST*/
  #if (IRQ_ETH6_EXIST == STD_ON)
  IRQ_SFR_MODIFY32 (SRC_GETH6.U , IRQ_CLEAR_MASK , \
                     ((uint32)IRQ_ETH_SR6_TOS |(uint32) IRQ_ETH_SR6_PRIO));
  #endif/*End of IRQ_ETH6_EXIST*/
  #if (IRQ_ETH7_EXIST == STD_ON)
  IRQ_SFR_MODIFY32 (SRC_GETH7.U , IRQ_CLEAR_MASK , \
                     ((uint32)IRQ_ETH_SR7_TOS |(uint32) IRQ_ETH_SR7_PRIO));
  #endif/*End of IRQ_ETH7_EXIST*/
  #if (IRQ_ETH8_EXIST == STD_ON)
  IRQ_SFR_MODIFY32 (SRC_GETH8.U , IRQ_CLEAR_MASK , \
                     ((uint32)IRQ_ETH_SR8_TOS |(uint32) IRQ_ETH_SR8_PRIO));
  #endif/*End of IRQ_ETH8_EXIST*/
  #if (IRQ_ETH9_EXIST == STD_ON)
  IRQ_SFR_MODIFY32 (SRC_GETH9.U , IRQ_CLEAR_MASK , \
                     ((uint32)IRQ_ETH_SR9_TOS |(uint32) IRQ_ETH_SR9_PRIO));
  #endif/*End of IRQ_ETH9_EXIST*/
}
#endif/*End of IRQ_ETH_EXIST*/
