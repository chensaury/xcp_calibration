//-----------------------------------------------------------------------------
// Program instrumentation for Vector VX1000 and Tricore DAP                                                                                                                               
...
#define VX1000_CLOCK STM_TIM0
  ...
  #define VX1000_CLOCK_TICKS_PER_MS 45000ULL // STM_TIM0 resolution (180.000 MHz)
#else
  #define VX1000_CLOCK_TICKS_PER_MS 33333ULL // STM_TIM0 resolution (133.333 MHz)
#endif
...
// Use the mailbox to do handle Flash Programming and PrintF
#define VX1000_MAILBOX
#define VX1000_MAILBOX_FLASH
