/**************************************************************************/
/* FILE NAME: mpc5567.h                      COPYRIGHT (c) Freescale 2006 */
...
/****************************************************************************/
    ...
    typedef union uMCR {
        ...
        struct {
            ...
            vuint16_t SFFE:1;   /* synchronization frame filter enable */
              vuint16_t:1;
            vuint16_t TMODE:1;  /* functional test mode */
              vuint16_t:3;
    ...
    typedef union uMBSSUTR {
        ...
        struct {
            ...
            vuint16_t LAST_MB_SEG1:5;   /* last message buffer control register for message buffer segment 1 */
              vuint16_t:3;
            vuint16_t LAST_MB_UTIL:5;   /* last message buffer utilized */
        } B;
    } MBSSUTR_t;
    ...
    typedef union uPADR {
        vuint16_t R;
        struct {
            vuint16_t PEADDR:15;        /* PE word address */
            vuint16_t DRD:1;    /* debug read done */
        } B;
    } PADR_t;
...
/* protocol commands */
    ...
    typedef union uPIFR1 {
        ...
        struct {
            ...
            vuint16_t DRDIF:1;  /* debug read done interrupt flag */
              vuint16_t:3;
        } B;
    } PIFR1_t;
    ...
    typedef union uPIER1 {
        ...
        struct {
            ...
            vuint16_t DRDIE:1;  /* debug read done interrupt enable */
              vuint16_t:3;
        } B;
    } PIER1_t;
...
/* wakeup status */
    ...
    typedef union uRFRFCFR {
        ...
        struct {
            ...
            vuint16_t FNUM:2;   /* filter number */
              vuint16_t:1;
...
#define CAN_E     (*( struct FLEXCAN2_tag *)  0xFFFD0000)
