...
#define CRO_SET_MTA_ADDR                                (CRO_BYTE(7)<<24)+(CRO_BYTE(6)<<16)+(CRO_BYTE(5)<<8)+CRO_BYTE(4)
...
#define CRO_SHORT_UPLOAD_ADDR                            (CRO_BYTE(7)<<24)+(CRO_BYTE(6)<<16)+(CRO_BYTE(5)<<8)+CRO_BYTE(4)
...
#define CRO_SET_DAQ_PTR_DAQ                             ((CRO_BYTE(3)<<8)+(CRO_BYTE(2)))
...
#define CRO_WRITE_DAQ_ADDR                             (CRO_BYTE(7)<<24)+(CRO_BYTE(6)<<16)+(CRO_BYTE(5)<<8)+CRO_BYTE(4)
...
#define CRO_SET_DAQ_LIST_MODE_DAQ                       (CRO_BYTE(3)<<8)+CRO_BYTE(2)
#define CRO_SET_DAQ_LIST_MODE_EVENTCHANNEL              (CRO_BYTE(5)<<8)+CRO_BYTE(4)
...
#define CRO_GET_DAQ_LIST_MODE_DAQ                       (CRO_BYTE(3)<<8)+CRO_BYTE(2)
...
#define CRO_START_STOP_DAQ                              (CRO_BYTE(3)<<8)+CRO_BYTE(2)
...
#define CRM_GET_DAQ_PROCESSOR_INFO_MAX_DAQ              (CRM_BYTE(3)<<8)+CRM_BYTE(2)
#define CRM_GET_DAQ_PROCESSOR_INFO_MAX_DAQ_WRITE(ndaq)  CRM_WORD_WRITE(1, ndaq)
#define CRM_GET_DAQ_PROCESSOR_INFO_MAX_EVENT            (CRM_BYTE(5)<<8)+CRM_BYTE(4)
...
#define CRO_ALLOC_DAQ_COUNT                            (CRO_BYTE(3)<<8)+CRO_BYTE(2)
...
#define CRO_ALLOC_ODT_DAQ                               (CRO_BYTE(3)<<8)+CRO_BYTE(2)
...
#define CRO_ALLOC_ODT_ENTRY_DAQ                         (CRO_BYTE(3)<<8)+CRO_BYTE(2)
...
#else
//extern void ApplXcpSend( vuint8 len, const BYTEPTR msg );//20201117这个才是经典么
//extern unsigned char ApplXcpSend(  unsigned char* msg );
#endif
...
extern unsigned long* ApplXcpGetPointer( vuint8 addr_ext, vuint32 addr );
#endif
...
#if defined ( XCP_ENABLE_SERV_TEXT_PRINT ) || defined ( XCP_DISABLE_SERV_TEXT_PRINT )
#else
  //#error "XCP consistency error: XcpPrint function must be enabled or disabled."20201117
#endif
#if defined ( XCP_ENABLE_SERV_TEXT ) && defined ( XCP_DISABLE_SERV_TEXT_PUTCHAR )
