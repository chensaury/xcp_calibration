...
group OS_STACK_OSCORE5_ERROR_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  ...
  reserved ".pad.OS_STACK_OSCORE5_ERROR_VAR_NOINIT" (size=16);
}
"_OS_STACK_OSCORE5_ERROR_VAR_NOINIT_START" = "_lc_gb_OS_STACK_OSCORE5_ERROR_VAR_NOINIT_GROUP";
"_OS_STACK_OSCORE5_ERROR_VAR_NOINIT_END" = "_lc_ub__pad_OS_STACK_OSCORE5_ERROR_VAR_NOINIT";
...
group OS_STACK_OSCORE5_INIT_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  ...
  reserved ".pad.OS_STACK_OSCORE5_INIT_VAR_NOINIT" (size=16);
}
"_OS_STACK_OSCORE5_INIT_VAR_NOINIT_START" = "_lc_gb_OS_STACK_OSCORE5_INIT_VAR_NOINIT_GROUP";
"_OS_STACK_OSCORE5_INIT_VAR_NOINIT_END" = "_lc_ub__pad_OS_STACK_OSCORE5_INIT_VAR_NOINIT";
...
group OS_STACK_OSCORE5_ISR_CORE_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  ...
  reserved ".pad.OS_STACK_OSCORE5_ISR_CORE_VAR_NOINIT" (size=16);
}
"_OS_STACK_OSCORE5_ISR_CORE_VAR_NOINIT_START" = "_lc_gb_OS_STACK_OSCORE5_ISR_CORE_VAR_NOINIT_GROUP";
"_OS_STACK_OSCORE5_ISR_CORE_VAR_NOINIT_END" = "_lc_ub__pad_OS_STACK_OSCORE5_ISR_CORE_VAR_NOINIT";
...
group OS_STACK_OSCORE5_KERNEL_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  ...
  reserved ".pad.OS_STACK_OSCORE5_KERNEL_VAR_NOINIT" (size=16);
}
"_OS_STACK_OSCORE5_KERNEL_VAR_NOINIT_START" = "_lc_gb_OS_STACK_OSCORE5_KERNEL_VAR_NOINIT_GROUP";
"_OS_STACK_OSCORE5_KERNEL_VAR_NOINIT_END" = "_lc_ub__pad_OS_STACK_OSCORE5_KERNEL_VAR_NOINIT";

/* Stack: OsCore5_Task_Prio100 (1024 Byte) */
group OS_STACK_OSCORE5_TASK_PRIO100_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  select ".bss.OS_STACK_OSCORE5_TASK_PRIO100_VAR_NOINIT";
  reserved ".pad.OS_STACK_OSCORE5_TASK_PRIO100_VAR_NOINIT" (size=16);
}
"_OS_STACK_OSCORE5_TASK_PRIO100_VAR_NOINIT_START" = "_lc_gb_OS_STACK_OSCORE5_TASK_PRIO100_VAR_NOINIT_GROUP";
"_OS_STACK_OSCORE5_TASK_PRIO100_VAR_NOINIT_END" = "_lc_ub__pad_OS_STACK_OSCORE5_TASK_PRIO100_VAR_NOINIT";

/* Stack: OsCore5_Task_Prio20 (1024 Byte) */
group OS_STACK_OSCORE5_TASK_PRIO20_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  select ".bss.OS_STACK_OSCORE5_TASK_PRIO20_VAR_NOINIT";
  reserved ".pad.OS_STACK_OSCORE5_TASK_PRIO20_VAR_NOINIT" (size=16);
}
"_OS_STACK_OSCORE5_TASK_PRIO20_VAR_NOINIT_START" = "_lc_gb_OS_STACK_OSCORE5_TASK_PRIO20_VAR_NOINIT_GROUP";
"_OS_STACK_OSCORE5_TASK_PRIO20_VAR_NOINIT_END" = "_lc_ub__pad_OS_STACK_OSCORE5_TASK_PRIO20_VAR_NOINIT";
...
group OS_STACK_OSCORE5_TASK_PRIO4294967295_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  ...
  reserved ".pad.OS_STACK_OSCORE5_TASK_PRIO4294967295_VAR_NOINIT" (size=16);
}
"_OS_STACK_OSCORE5_TASK_PRIO4294967295_VAR_NOINIT_START" = "_lc_gb_OS_STACK_OSCORE5_TASK_PRIO4294967295_VAR_NOINIT_GROUP";
"_OS_STACK_OSCORE5_TASK_PRIO4294967295_VAR_NOINIT_END" = "_lc_ub__pad_OS_STACK_OSCORE5_TASK_PRIO4294967295_VAR_NOINIT";
...
group OS_STACK_OSCORE5_TASK_PRIO50_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  ...
  reserved ".pad.OS_STACK_OSCORE5_TASK_PRIO50_VAR_NOINIT" (size=16);
}
"_OS_STACK_OSCORE5_TASK_PRIO50_VAR_NOINIT_START" = "_lc_gb_OS_STACK_OSCORE5_TASK_PRIO50_VAR_NOINIT_GROUP";
"_OS_STACK_OSCORE5_TASK_PRIO50_VAR_NOINIT_END" = "_lc_ub__pad_OS_STACK_OSCORE5_TASK_PRIO50_VAR_NOINIT";



} /* OS_CORE5_STACKS_GROUP */
"_OS_CORE5_STACKS_START" = "_lc_gb_OS_CORE5_STACKS_GROUP";
"_OS_CORE5_STACKS_END" = "_lc_ge_OS_CORE5_STACKS_GROUP";
