...
#define MCALLIB_SID_GETVERSIONINFO                 ((uint8)0x0U)
#define MCALLIB_SID_GETSPINLOCK                    ((uint8)0x14U)
#define MCALLIB_SID_RELSPINLOCK                    ((uint8)0x15U)
#define MCALLIB_SID_CPUENDINIT                     ((uint8)0X03U)
#define MCALLIB_SID_SAFETYENDINIT                  ((uint8)0x06U)
#define MCALLIB_SID_SAFETYENDINITMASK              ((uint8)0x16U)
#define MCALLIB_SID_PERIPHERALENDINIT              ((uint8)0x09U)
#define MCALLIB_SID_DELAYTICKRESOLUTION            ((uint8)0x10U)
